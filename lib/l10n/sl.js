OC.L10N.register(
    ...
    "Running ownCloud Server on the Microsoft Windows platform is not supported. We suggest you use a Linux server in a virtual machine if you have no option for migrating the server itself. Find Linux packages as well as easy to deploy virtual machine images on <a href=\"%s\">%s</a>. For migrating existing installations to Linux you can find some tips and a migration script in <a href=\"%s\">our documentation</a>." : "Namestitev strežnika ownCloud v okolju Microsoft Windows ni podprto. Priporočeno je uporabiti strežnik z operacijskim sistemom Linux na navideznem strežniku, če ni možnosti nastavitve ločene enote. Pakete za sistem Linux je mogoče najti na <a href=\"%s\">%s</a>. Za prenos obstoječih namestitev na Linux pa je dobro poznati nekaj priporočil, ki so  zapisane <a href=\"%s\">v dokumentaciji</a>.",
