OC.L10N.register(
    ...
    "%s via %s" : "%s përmes %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Ndarja me të tjerët e %s dështoi, ngaqë mekanizmi i pasëm nuk lejon ndarje të llojit %d",
