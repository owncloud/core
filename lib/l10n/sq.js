OC.L10N.register(
    ...
    "%s via %s" : "%s përmes %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Ndarja me të tjerët e %s dështoi, ngaqë mekanizmi i pasmë nuk lejon ndarje të llojit %d",
    ...
    "Cannot set the requested share permissions for %s" : "S’caktohen dot lejet e kërkuara për ndarje për %s",
    "Cannot set the requested share attributes for %s" : "S’caktohen dot atributet e kërkuara për ndarje për %s",
