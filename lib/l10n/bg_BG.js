OC.L10N.register(
    ...
    "App \"%s\" cannot be installed because appinfo file cannot be read." : "Приложение \"%s\" не може да бъде инсталирано, защото appinfo файлът не може да бъде прочетен.",
    "App \"%s\" cannot be installed because it is not compatible with this version of ownCloud." : "Приложение \"%s\" не може да бъде инсталирано, защото не е съвместимо с тази версия на ownCloud.",
    "No app name specified" : "Не е зададено име на преложението",
    "App '%s' could not be installed!" : "Приложение '%s' не може да бъде инсталирано!",
