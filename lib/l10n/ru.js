OC.L10N.register(
    ...
    "No minimum ownCloud version is defined in appinfo/info.xml." : "Минимальная версия ownCloud не задана в appinfo/info.xml.",
    "ownCloud %s or lower is required." : "Требуется ownCloud версии %s или ниже.",
    "No maximum ownCloud version is defined in appinfo/info.xml." : "Максимальная версия ownCloud не задана в appinfo/info.xml.",
    ...
    "File cannot be read" : "Невозможно прочитать файл",
