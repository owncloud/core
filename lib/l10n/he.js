OC.L10N.register(
    ...
    "No minimum ownCloud version is defined in appinfo/info.xml." : "לא מוגדרת גרסת מינימום של ownCloud בקובץ appinfo/info.xml.",
    "ownCloud %s or lower is required." : "נדרש ownCloud %s ומטה.",
    "No maximum ownCloud version is defined in appinfo/info.xml." : "לא מוגדרת גרסת מקסימום של ownCloud בקובץ appinfo/info.xml.",
