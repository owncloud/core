OC.L10N.register(
    ...
    "%s is not supported and %s will not work properly on this platform. Use it at your own risk! " : "%s desteklenmez ve %s bu platformda düzgün çalışmaz. Kendi sorumluluğunuzdadır kullanın!",
    ...
    "Can't create or write into the apps-external directory %s" : "Uygulamaların harici dizini oluşturulamıyor veya bu dizine yazılamıyor %s",
    ...
    "Your Data directory must be an absolute path" : "Veri dizininiz tam bir yol olmalıdır",
