OC.L10N.register(
    ...
    "Archive does not contain a directory named %s" : "لا يحتوي سجل المحفوظات على مجلد باسم %s",
    ...
    "%s you may not use dots in the database name" : "%s لا يُسمَح لك باستخدام نقطة في اسم قاعدة البيانات",
    ...
    "Sharing %s failed, because you can not share with yourself" : "فشلت مشاركة %s؛ لأنك لا تتمكن من المشاركة مع نفسك",
    ...
    "Cannot write into \"config\" directory" : "تعذّرت الكتابة في دليل \"config\"",
