OC.L10N.register(
    ...
    "No path specified when installing app from local file" : "ไม่ได้ระบุเส้นทางไว้เมื่อกำลังติดตั้งแอปฯจากไฟล์ในเครื่อง",
    ...
    "App can't be installed because it is not compatible with this version of ownCloud" : "ไม่สามารถติดตั้งแอปพลิเคชันเพราะมันเข้ากันไม่ได้กับรุ่นของ ownCloud นี้",
    ...
    "App can't be installed because the version in info.xml is not the same as the version reported from the app store" : "ไม่สามารถติดตั้งแอปฯ เพราะว่ารุ่นของ info.xml ไม่ตรงกับรุ่นที่ระบุไว้จากแอปสโตร์",
    "Your Enterprise license key has expired." : "รหัส Enterprise license ของคุณหมดอายุแล้ว",
    "Apps" : "แอปฯ",
    "General" : "ทั่วไป",
