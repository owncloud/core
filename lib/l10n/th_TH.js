OC.L10N.register(
    ...
    "No minimum ownCloud version is defined in appinfo/info.xml." : "ไม่ได้กำหนดรุ่น ownCloud ต่ำสุดใน appinfo/info.xml",
    "ownCloud %s or lower is required." : "ต้องการ ownCloud %s หรือรุ่นที่ต่ำกว่า",
    "No maximum ownCloud version is defined in appinfo/info.xml." : "ไม่ได้กำหนดรุ่น ownCloud สูงสุดใน appinfo/info.xml",
    ...
    "No path specified when installing app from local file" : "ไม่ได้ระบุเส้นทางไว้เมื่อกำลังติดตั้งแอพฯจากไฟล์ในเครื่อง",
    "Archives of type %s are not supported" : "ประเภทข้อมูลที่เก็บของ %s ไม่ได้รับการสนับสนุน",
    "Failed to open archive when installing app" : "ไม่สามารถเปิดที่เก็บข้อมูลเมื่อกำลังติดตั้งแอพพลิเคชัน",
    ...
    "Can't create or write into the apps-external directory %s" : "ไม่สามารถสร้างหรือเขียนลงในไดเรกทอรีภายนอกแอพ %s",
    ...
    "Application is not enabled" : "แอพพลิเคชันดังกล่าวยังไม่ได้เปิดใช้งาน",
