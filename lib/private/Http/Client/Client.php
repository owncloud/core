...
class Client implements IClient {
	...
	private function setDefaultOptions() {
		...
		// ToDo: this $config stuff comes from the previous PR for Guzzle6
		//       But it does not seem to go anywhere. `verify` etc is set, but
		//       when this function ends the $config array is just thrown away.
		//       Need to investigate what really should happen with this.
