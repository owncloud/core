<?php
/**
 * This is a clone of the OpenSSL mixer from RandomLib but with an assigned strength
 * of medium instead of high. This is useful because there are cases where /dev/urandom
 * is not readable and thus we should have another randomness source.
 *
...
namespace OC\Security\RandomNumberGenerator;
