...
class Constants {
	...
	public const SHARE_TYPE_USERGROUP = 2; // Special share type for user modified group shares
	...
	public const SHARE_TYPE_REMOTE = 6;  // outgoing end of a federated share
