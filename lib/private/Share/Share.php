...
class Share extends Constants {
	...
	public static function unshareFromSelf($itemType, $itemOrigin, $originIsSource = false) {
		...
		if (!$itemUnshared && isset($groupShare) && !isset($uniqueGroupShare)) {
			...
			$listOfUnsharedItems = array_merge($listOfUnsharedItems, [$groupShare]);
			$itemUnshared = true;
			...
			$listOfUnsharedItems = array_merge($listOfUnsharedItems, [$uniqueGroupShare]);
			$itemUnshared = true;
		}
	...
	public static function checkPasswordProtectedShare(array $linkItem) {
		...
		if ( \OC::$server->getSession()->exists('public_link_authenticated')
			...
			&& \OC::$server->getShareManager()->checkPassword(\OC::$server->getShareManager()->getShareById('ocinternal:' . $linkItem['id']), \OC::$server->getSession()->get('public_link_password')) ) {
			return true;
		}
