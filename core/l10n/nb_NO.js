OC.L10N.register(
    ...
    "Receive files from others without revealing the contents of the folder." : "Motta filer fra andre uten å avsløre innholdet i mappen.",
    "Read only" : "Kun lese",
    "Users can view and download contents." : "Brukere kan se og laste ned innhold.",
    "Read & Write" : "Les & Skriv",
    "Users can view, download, edit and upload contents." : "Brukere kan se, laste ned, redigere og laste opp innhold.",
    ...
    "{email} is not a valid address!" : "{email} er ikke en gyldig adresse!",
    ...
    "Log in" : "Logg inn",
    "You took too long to login, please try again now" : "Du tok for lang tid til å logge inn, prøv igjen nå",
