OC.L10N.register(
    ...
    "Password" : "Senha",
    "Upload only (File Drop)" : "Apenas enviar (Deixar um Arquivo)",
    "Receive files from others without revealing the contents of the folder." : "Receba arquivos de outros sem revelar o conteúdo da pasta.",
    "Read only" : "Somente leitura",
    "Users can view and download contents." : "Usuários podem ver e baixar conteúdos.",
    "Read & Write" : "Ler & Escrever",
    "Users can view, download, edit and upload contents." : "Usuários podem ver, baixar, editar e enviar conteúdos.",
