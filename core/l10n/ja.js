OC.L10N.register(
    ...
    "Recipients can view or download contents." : "相手はコンテンツを表示またはダウンロードできます。",
    "Download / View / Upload" : "ダウンロード / 表示 / アップロード",
    "Recipients can view, download, edit, delete and upload contents." : "相手はコンテンツを表示、ダウンロード、編集、削除、およびアップロードできます。",
