OC.L10N.register(
    ...
    "Receive files from others without revealing the contents of the folder." : "Merr kartela prej të tjerësh pa e zbuluar lëndën e dosjes.",
    "Read only" : "Vetëm për lexim",
    "Users can view and download contents." : "Përdoruesit mund të shohin dhe shkarkojnë lëndë.",
    "Read & Write" : "Lexim & Shkrim",
    "Users can view, download, edit and upload contents." : "Përdoruesit mund të shohin, shkarkojnë, përpunojnë dhe ngarkojnë lëndë.",
    ...
    "{email} is not a valid address!" : "{email} s’është adresë e vlefshme!",
    "An error occured" : "Ndodhi një gabim",
