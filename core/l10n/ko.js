OC.L10N.register(
    ...
    "Filename" : "파일 이름",
    "Password" : "암호",
    "Upload only (File Drop)" : "업로드만(파일 끌어다 놓기)",
    "Receive files from others without revealing the contents of the folder." : "폴더 내용을 공개하지 않고 다른 사용자로부터 파일을 받습니다.",
    "Read only" : "읽기 전용",
    "Users can view and download contents." : "사용자가 내용을 보고 다운로드할 수 있습니다.",
    "Read & Write" : "읽기 및 쓰기",
    "Users can view, download, edit and upload contents." : "사용자가 내용을 보고 다운로드하고 업로드할 수 있습니다.",
