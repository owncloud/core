OC.L10N.register(
    ...
    "Receive files from others without revealing the contents of the folder." : "ניתן לשתף קבצים עם אחרים מבלי לחשוף את תכני התיקייה.",
    "Read only" : "קריאה בלבד",
    "Users can view and download contents." : "משתמשים יכולים לצפות בתכנים ולהוריד אותם.",
    "Read & Write" : "קריאה וכתיבה",
    "Users can view, download, edit and upload contents." : "משתמשים יכולים לצפות, להוריד, לערוך ולהעלות תכנים.",
    ...
    "{email} is not a valid address!" : "הכתובת {email} אינה תקנית!",
