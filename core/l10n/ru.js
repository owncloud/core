OC.L10N.register(
    ...
    "Filename" : "Имя файла",
    "Password" : "Пароль",
    "Upload only (File Drop)" : "Только закачка (закинуть файл)",
    "Receive files from others without revealing the contents of the folder." : "Получение файлов от других без раскрытия содержимого каталога.",
    "Read only" : "Только чтение",
    "Users can view and download contents." : "Пользователи могут просматривать и скачивать содержимое.",
    "Read & Write" : "Чтение и запись",
    "Users can view, download, edit and upload contents." : "Пользователи могут просматривать, скачивать, править и закачивать содержимое.",
    ...
    "{sharee} (federated)" : "{sharee} (удалённо)",
    "Share" : "Поделиться",
