OC.L10N.register(
    ...
    "There are currently no link shares, you can create one" : "В момента няма споделени връзки, но можеш да създадеш.",
    "Anyone with the link has access to the file/folder" : "Всеки знаещ тази връзка ще има достъп до файла/директорията",
    "Copied!" : "Копирано!",
