OC.L10N.register(
    ...
    "Filename" : "Filnavn",
    "Password" : "Passord",
    "Upload only (File Drop)" : "Kun opplasting (slepp fila her)",
    "Receive files from others without revealing the contents of the folder." : "Mota fil frå andre utan å vise innhaldet av mappa.",
    "Read only" : "Kun les",
    "Users can view and download contents." : "Brukarar kan sjå og laste ned innhaldet.",
    "Read & Write" : "Les og skriv",
    "Users can view, download, edit and upload contents." : "Brukar kan sjå, laste ned, endre og laste opp innhald.",
