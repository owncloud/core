OC.L10N.register(
    ...
    "Hey there,<br><br>just letting you know that you now have an %s account.<br><br>Your username: %s<br>Please set the password by accessing it: <a href=\"%s\">Here</a><br><br>" : "Ola,<br><br>só facerlle saber que agora dispón dunha conta %s.<br><br>O seu nome de usuario: %s<br>Estabeleza un contrasinal accedendo a ela: <a href=\"%s\">Dende aquí</a><br><br>",
