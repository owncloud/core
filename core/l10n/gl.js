OC.L10N.register(
    ...
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Comezou un período de graza de 24 horas para permitirlle poñerse en marcha de inmediato. Unha vez que remate o período de graza, todas as aplicacións Empresarial quedarán desactivadas a menos que proporcione unha chave de licenza válida.",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Para probar ownCloud Empresarial, só ten que iniciar unha demostración de 30 días e escriba a chave de licenza indicada a seguir.",
    "Upgrade to ownCloud Enterprise" : "Anovar a ownCloud Empresarial",
    "Remaining time: {rtime}" : "Tempo restante: {rtime}",
    "Get your demo key" : "Obter a súa chave de demostración",
    "Enter license key" : "Introducir a chave de licenza",
    "Set new key" : "Estabelecer unha nova chave",
