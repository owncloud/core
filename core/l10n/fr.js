OC.L10N.register(
    ...
    "{fileName} link" : "Lien vers {fileName}",
    "Link" : "Lien",
    ...
    "Upload only (File Drop)" : "Téléversement seulement (Glisser le Fichier)",
    "Receive files from others without revealing the contents of the folder." : "Recevoir les fichiers des autres sans révéler le contenu du dossier.",
    "Read only" : "Lecture seule",
    "Users can view and download contents." : "Les utilisateurs peuvent visualiser et télécharger les contenus.",
    "Read & Write" : "Lire et Ecrire",
    "Users can view, download, edit and upload contents." : "Les utilisateurs peuvent visualiser, télécharger, éditer et mettre à jour les contenus.",
    ...
    "Log in" : "Se connecter",
    "You took too long to login, please try again now" : "Vous avez mis trop longtemps pour vous connecter, veuillez réessayer maintenant",
