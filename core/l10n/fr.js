OC.L10N.register(
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "Il semble que votre instance héberge beaucoup de fichier et/ou d'utilisateurs. Pour un processus de mise à niveau sans difficulté ,veuillez utiliser l'outil de mise à jour via l'interface en ligne de commande (occ upgrade).",
