OC.L10N.register(
    ...
    "Filename" : "Dateiname",
    "Password" : "Passwort",
    "Upload only (File Drop)" : "Nur hochladen (Datei hineinziehen)",
    "Receive files from others without revealing the contents of the folder." : "Von anderen Dateien empfangen, ohne den Inhalt des Ordners preiszugeben.",
    "Read only" : "Schreibgeschützt",
    "Users can view and download contents." : "Nutzer können den Inhalt sehen und herunterladen.",
    "Read & Write" : "Lesen & Schreiben",
    "Users can view, download, edit and upload contents." : "Nutzer können den Inhalt sehen, herunterladen, ändern und Inhalt hochladen.",
    ...
    "Log in" : "Anmelden",
    "You took too long to login, please try again now" : "Sie haben zu lange benötigt, um sich einzuloggen. Bitte versuchen Sie es jetzt erneut.",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "Es scheint, dass deine Instanz viele Dateien und / oder Benutzer verwaltet. Um einen reibungslosen Upgradeprozess sicherzustellen, bitte den Kommandozeilenupdater (occ upgrade) verwenden.",
