OC.L10N.register(
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "ดูเหมือนว่าอินสแตนซ์ของคุณอาจมีโฮสต์ ไฟล์หรือผู้ใช้จำนวนมากเพื่อให้แน่ใจว่ากระบวนการอัพเกรดทำงานได้ปกติดี โปรดใช้คำสั่งอัปเดต (occ upgrade)",
    "Automatic updating is disabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "การอัปเดตโดยอัตโนมัติถูกปิดใช้งานใน config.php เพื่ออัพเกรดอินสแตนซ์ของคุณโปรดใช้คำสั่งอัปเดต (occ upgrade)",
