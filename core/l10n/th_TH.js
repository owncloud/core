OC.L10N.register(
    ...
    "Checking updates of apps" : "กำลังตรวจสอบการอัปเดตแอพพลิเคชัน",
    ...
    "Checked database schema update for apps" : "Schema อัปเดตของฐานข้อมูลสำหรับแอพฯ",
    ...
    "Updating to {version}" : "กำลังอัปเดตเป็นรุ่น {version}",
    ...
    "App update required" : "จำเป้นต้องอัปเดตแอพฯ",
    "%s will be updated to version %s" : "%s จะถูกอัปเดตเป็นเวอร์ชัน %s",
    "These apps will be updated:" : "แอพพลิเคชันเหล่านี้จะถูกอัปเดต:",
