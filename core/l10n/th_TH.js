OC.L10N.register(
    ...
    "Checked database schema update" : "Schema อัพเดทของฐานข้อมูลถูกตรวจสอบ",
    ...
    "Checked database schema update for apps" : "Schema อัพเดทของฐานข้อมูลสำหรับแอพฯ",
    "Updated \"%s\" to %s" : "อัพเดท \"%s\" ไปยัง %s",
    "Set log level to debug" : "ตั้งค่าระดับของไฟล์บันทึกเพื่อแก้ไขปัญหา",
    "Reset log level" : "ตั้งค่าระดับของไฟล์บันทึกใหม่",
    ...
    "There are currently no link shares, you can create one" : "ขณะนี้ยังไม่มีการแชร์ลิงค์ใดๆ",
    "Anyone with the link has access to the file/folder" : "ทุกคนที่มีลิงค์สามารถเข้าถึงไฟล์หรือโฟลเดอร์ได้",
    "Copied!" : "คัดลอกแล้ว!",
    ...
    "Filename" : "ชื่อไฟล์",
    "Password" : "รหัสผ่าน",
    "Upload only (File Drop)" : "เฉพาะอัพโหลด (วางไฟล์)",
    "Receive files from others without revealing the contents of the folder." : "รับไฟล์จากบุคคลอื่นโดยไม่ต้องเปิดเผยเนื้อหาของโฟลเดอร์",
    "Read only" : "อ่านอย่างเดียว",
    "Users can view and download contents." : "ผู้ใช้สามารถดูและดาวน์โหลดเนื้อหา",
    "Read & Write" : "อ่านและเขียน",
    "Users can view, download, edit and upload contents." : "ผู้ใช้สามารถดู ดาวน์โหลด แก้ไข และอัพโหลดเนื้อหาได้",
    ...
    "Send link via email" : "ส่งลิงค์ผ่านทางอีเมล",
    ...
    "You are trying to access a private link. Please log in first." : "คุณกำลังพยายามเข้าถึงลิงค์ส่วนตัว โปรดเข้าสู่ระบบก่อน",
