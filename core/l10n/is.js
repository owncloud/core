OC.L10N.register(
    ...
    "Receive files from others without revealing the contents of the folder." : "Fá skrár frá öðrum án þess að birta innihald möppunnar.",
    "Read only" : "Skrifvarið",
    "Users can view and download contents." : "Notendur geta skoðað og sótt innihaldið.",
    "Read & Write" : "Les- & skrifanlegt",
    "Users can view, download, edit and upload contents." : "Notendur geta skoðað, sótt og breytt innihaldinu.",
    ...
    "{email} is not a valid address!" : "{email} er ekki gilt tölvupóstfang!",
