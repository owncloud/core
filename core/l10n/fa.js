OC.L10N.register(
    ...
    "Couldn't send mail to following users: %s " : "نمی توان برای کاربران زیر ایمیل فرستاد: %s",
    ...
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "هیچ حافظه پنهانی پیکربندی نشده است. برای افزایش کارایی خود لطفا یک حافظه پنهان را در صورت موجود بودن پیکربندی کنید. اطلاعات بیشتر در <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a> ما یافت می شود.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing ownCloud from a trusted proxy. If you are not accessing ownCloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to ownCloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "پیکربندی سرتیترهای پروکسی  معکوس  نادرست است، یا شما از یک پروکسی مطمئن به ownCloud دسترسی دارید. اگر از یک پروکسی مطمئن به ownCloud دسترسی ندارید، این یک موضوع امنیتی است و می تواند به یک مهاجم اجازه دهد  تا آدرس IP آن ها را به طور نمایان در ownCloud ...",
    ...
    "Filename" : "نام فایل",
    "Password" : "گذرواژه",
    "Upload only (File Drop)" : "فقط بارگذاری (حذف پرونده)",
    "Receive files from others without revealing the contents of the folder." : "پرونده ها را بدون آشکار شدن محتوای پوشه از سایرین دریافت کنید.",
    "Read only" : "فقط خواندنی",
    "Users can view and download contents." : "کاربران می توانند محتوا را ببینند و دانلود کنند.",
    "Read & Write" : "خواندن و نوشتن",
    "Users can view, download, edit and upload contents." : "کاربران می توانند محتوا را ببینند، دانلود و ویرایش و بارگذاری کنند.",
