OC.L10N.register(
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing ownCloud from a trusted proxy. If you are not accessing ownCloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to ownCloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Η ρύθμιση των reverse proxy headers δεν είναι σωστή ή συνδέεστε στο ownCloud από ένα έμπιστο διαμεσολαβητή. Αν δεν συνδέεστε στο ownCloud από έμπιστο διαμεσολαβητή, αυτό είναι ένα θέμα ασφαλείας και μπορεί να επιτρέψει σε έναν εισβολέα την διεύθυνση IP του παραπλανητικά ως ορατή ownCloud. Περισσότερες πληροφορίες υπάρχουν στην <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">τεκμηρίωση</a>.",
    ...
    "Show file listing" : "Εμφάνιση αρχείου καταγραφής",
    ...
    "{sharee} (federated)" : "{sharee} (απομακρυσμένο)",
    "Share" : "Διαμοιρασμός",
