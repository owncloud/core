OC.L10N.register(
    ...
    "Please use the command line updater because automatic updating is disabled in the config.php." : "Παρακαλώ χρησιμοποιήστε την αναβάθμιση μέσω τερματικού επειδή η αυτόματη ενημέρωση είναι απενεργοποιημένη στο config.php.",
    ...
    "Reset log level" : "Επαναφορά καταγραφής επιπέδου",
    "Starting code integrity check" : "Εκκίνηση ελέγχου ακεραιότητας κωδικού",
    "Finished code integrity check" : "Ολοκλήρωση ελέγχου ακεραιότητας κωδικού",
    ...
    "Settings" : "Ρυθμίσεις",
    "Problem loading page, reloading in 5 seconds" : "Πρόβλημα φόρτωσης σελίδας, επαναφόρτωση σε 5 δευτερόλεπτα",
    ...
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Δεν έχει ρυθμιστεί η λανθάνουσα μνήμη. Για βελτίωση της απόδοσής σας παρακαλώ ρυθμίστε την εφαρμογή memcache εάν είναι διαθέσιμη. Μπορείτε να βρείτε περισσότερες πληροφορίες στην <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">τεκμηρίωση</a>.",
    "/dev/urandom is not readable by PHP which is highly discouraged for security reasons. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Το /dev/urandom δεν είναι αναγνώσιμο από την PHP, το οποίο δεν συνίσταται για λόγους ασφαλείας. Περισσότερες πληροφορίες υπάρχουν στην <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">τεκμηρίωσή</a> μας.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing ownCloud from a trusted proxy. If you are not accessing ownCloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to ownCloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Η ρύθμιση των reverse proxy headers δεν είναι σωστή ή συνδέεστε στο ownCloud από ένα έμπιστο διαμεσολαβητή. Αν δεν συνδέεστε στο ownCloud από έμπιστο διαμεσολαβητή, αυτό είναι ένα θέμα ασφαλείας και μπορεί να επιτρέψει σε έναν επιτιθέμενο να μασκαρέψει τη διεύθυνση IP του ως ορατή στο ownCloud. Περισσότερες πληροφορίες υπάρχουν στην <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">τεκμηρίωση</a>.",
    ...
    "Some files have not passed the integrity check. Further information on how to resolve this issue can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>. (<a href=\"{codeIntegrityDownloadEndpoint}\">List of invalid files…</a> / <a href=\"{rescanEndpoint}\">Rescan…</a>)" : "Μερικά αρχεία δεν περάσανε έλεγχο ακεραιότητας. Περισσότερες πληροφορίες για το πως να επιλύσετε πρόβλημα μπορείτε να βρείτε στην <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">τεκμηρίωση</a>. (<a href=\"{codeIntegrityDownloadEndpoint}\">Λίστα μη έγκυρων αρχείων…</a> / <a href=\"{rescanEndpoint}\">Σάρωση ξανά…</a>)",
    ...
    "{fileName} link" : "{fileName} σύνδεσμος",
    "Link" : "Σύνδεσμος",
    ...
    "Could not unshare" : "Αδυναμία αναίρεσης διαμοιρασμού",
    ...
    "Username or email" : "Όνομα χρήστη ή διεύθυνση email",
    "Log in" : "Είσοδος",
    ...
    "Enhanced security has been enabled for your account. Please authenticate using a second factor." : "Έχει ενεργοποιηθεί βελτιωμένη ασφάλεια για τον λογαριασμό σας. Παρακαλώ πιστοποιήστε με την χρήση δεύτερου παράγοντα.",
    "Cancel login" : "Ακύρωση εισόδου",
    "Please authenticate using the selected factor." : "Παρακαλώ πιστοποιήστε με την χρήση του επιλεγμένου παράγοντα.",
    ...
    "Please use the command line updater because you have a big instance." : "Παρακαλώ χρησιμοποιήστε την αναβάθμιση μέσω τερματικού επειδή έχετε μεγάλη εγκατάσταση.",
