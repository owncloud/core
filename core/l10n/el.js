OC.L10N.register(
    ...
    "Couldn't send mail to following recipient(s): %s " : "Αδυναμία αποστολής αλληλογραφίας στους παρακάτω παραλήπτες: %s ",
    ...
    "Owner: {owner}" : "Ιδιοκτήτης: {owner}",
    "Shared with you and the group {group} by {owner}" : "Διαμοιράστηκε με σας και με την ομάδα {group} από τον {owner}",
    "Shared with you by {owner}" : "Διαμοιράστηκε με σας από τον {owner}",
    "Share with user {shareWith} has attribute {name} which is no longer available. Please recreate the share!" : "Η κοινή χρήση με το χρήστη {shareWith} έχει το χαρακτηριστικό {name} το οποίο δεν είναι πλέον διαθέσιμο. Παρακαλούμε δημιουργήστε ξανά το κοινόχρηστο!",
    "group" : "ομάδα",
    "federated" : "federated",
