OC.L10N.register(
    ...
    "Error setting expiration date" : "Error al fixar le data de expiration",
    ...
    "Choose a password for the public link or press enter" : "Elige un contrasigno pro le ligamine public o preme Enter",
    "Copied!" : "Copiate.",
    ...
    "Warning" : "Aviso",
    "Error while sending notification" : "Error al inviar notification",
    ...
    "Please contact the server administrator if this error reappears multiple times, please include the technical details below in your report." : "Per favor contacta le administrator del servitor si iste error reappare plure vices e include le detalios technic sequente in tu reporto.",
    "More details can be found in the server log." : "Plus detalios se trova in le registro del servitor.",
    ...
    "Your data directory and files are probably accessible from the internet because the .htaccess file does not work." : "Tu directorio de datos e tu files es probabilemente accessibile ab internet perque le file .htaccess non functiona.",
    "For information how to properly configure your server, please see the <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">documentation</a>." : "Pro apprender como configurar adequatemente tu servitor, vide le <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">documentation</a>.",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. An example configuration is provided in config/config.sample.php." : "Per favor, contacta tu administrator. Si tu es un administrator de iste installation, configura le parametro \"trusted_domains\" in config/config.php. Un exemplo de configuration es fornite in config/config.sample.php.",
    "Depending on your configuration, as an administrator you might also be able to use the button below to trust this domain." : "Dependente de tu configuration, como administrator es possibile que tu pote usar le button sequente pro fider a iste dominio.",
    "Add \"%s\" as trusted domain" : "Adder \"%s\" como dominio fidite",
