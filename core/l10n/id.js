OC.L10N.register(
    "core",
    {
    "Please select a file." : "Mohon pilih sebuah data.",
    ...
    "Could not reset password because the token expired" : "Tidak dapat menyetel ulang sandi karena token kadaluarsa",
    ...
    "Recipients can view, download and upload contents." : "Penerima dapat melihat, mengunduh dan meng unggah konten.",
    ...
    "Share with user {shareWith} has attribute {name} which is no longer available. Please recreate the share!" : "Pembagian dengan pengguna {bagikanDengan} yang memiliki atribut {nama} yang sudah tidak tersedia. Mohon buat ulang pembagian tersebut!",
    "group" : "grup",
