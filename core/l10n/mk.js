OC.L10N.register(
    ...
    "Couldn't send mail to following recipient(s): %s " : "Не можеше да се испрати пошта до следниве приматели: %s ",
    ...
    "Receive files from others without revealing the contents of the folder." : "Добивајте датотеки од други без да ја откриете содржината на папката.",
    "Read only" : "Само Читај",
    "Users can view and download contents." : "Корисниците можат само да ја видат и превземат содржината.",
    "Read & Write" : "Читање & Запишување",
    "Users can view, download, edit and upload contents." : "Корисниците можат да ја видат, превземат, изменат и да прикачат нова содржина.",
    ...
    "{email} is not a valid address!" : "{email} не е валидна Email адреса!",
