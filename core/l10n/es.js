OC.L10N.register(
    ...
    "Invalid file provided" : "El archivo provisto no es válido",
    ...
    "Filename" : "Nombre",
    "Password" : "Contraseña",
    "Upload only (File Drop)" : "Sólo subir (Goteo de Archivo)",
    "Receive files from others without revealing the contents of the folder." : "Reciba archivos de otros sin revelar el contenido de la carpeta.",
    "Read only" : "Sólo leer",
    "Users can view and download contents." : "Los usuarios pueden ver y descargar contenidos.",
    "Read & Write" : "Leer y Escribir",
    "Users can view, download, edit and upload contents." : "Los usuarios pueden ver, descargar, editar y subir contenidos.",
    ...
    "{sharee} (federated)" : "{sharee} (remoto)",
    "Share" : "Compartir",
