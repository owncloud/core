...
<div id="postsetupchecks">
	...
	<div class="section" id="shareAPI">
		...
		<p class="<?php if ($_['shareAPIEnabled'] === 'no') p('hidden');?>">
			...
			<label for="shareapi_allow_share_dialog_user_enumeration"><?php p($l->t('Allow username autocomplete in share dialog. If this is disabled the full username needs to be entered.'));?></label><br />
		</p>
