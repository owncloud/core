OC.L10N.register(
    ...
    "Language" : "Мова",
    "Apps Management" : "Кіраванне праграмамі",
    ...
    "Show enabled apps" : "Паказаць уключаныя праграмы",
    "Show disabled apps" : "Паказаць выключаныя праграмы",
    "Cron" : "Cron",
    "Open documentation" : "Адкрыць дакументацыю",
    "Enable encryption" : "Уключыць шыфраванне",
    "Sharing" : "Абагульванне",
    "Allow resharing" : "Дазволіць абагульванне",
    "Save" : "Захаваць",
    "Log" : "Журнал",
    ...
    "You are using %s" : "Вы выкарыстоўваеце %s",
    ...
    "Storage Location" : "Размяшчэнне сховішча"
},
