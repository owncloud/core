OC.L10N.register(
    ...
    "installing and updating apps via the market or Federated Cloud Sharing" : "instalando y actualizando aplicaciones por medio de: Market o Nube compartida Federada",
    ...
    "Restrict users to only share with groups they are member of" : "Restrinja a los usuarios compartir sólo con grupos de los que son miembros",
    ...
    "App passwords / tokens" : "Contraseña de App / tokens",
    "You've linked these apps." : "Has enlazado estas apps.",
    "Name" : "Nombre",
    "App passwords or tokens are passcodes that give an app or device permissions to access your %s account." : "La contraseña de app o los tokens son contraseñas que permiten a la app o al dispositivo acceder a tu cuenta %s .",
    "Use them as a security measure to hide your actual password which you may only want to use for web interface login." : "Úselos como medida de seguridad para ocultar su contraseña actual, que debe ser usada unicamente para logarse en la interfaz Web.",
    "App name" : "nombre de la app",
    "Create new app passcode" : "Crear una contraseña de app nueva",
