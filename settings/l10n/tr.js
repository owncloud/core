OC.L10N.register(
    ...
    "installing and updating apps via the market or Federated Cloud Sharing" : "uygulamaları market veya Dağıtık Bulut Paylaşımları yoluyla yükleme ve güncelleme",
    ...
    "Restrict enumeration to group members" : "Sayım listesini grup üyeleriyle kısıtla",
    ...
    "In a clustered setup please make sure to sync the config.php file across all nodes." : "Kümelenmiş bir kurulumda lütfen config.php dosyasını tüm düğümlerde senkronize ettiğinizden emin olun.",
    ...
    "Transactional file locking should be configured to use memory-based locking, not the default slow database-based locking. See the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation ↗</a> for more information." : "İşlemsel dosya kilitleme, varsayılan yavaş veritabanı tabanlı kilitleme yerine bellek tabanlı kilitleme kullanacak şekilde yapılandırılmalıdır. Daha fazla bilgi için <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">dokümantasyona ↗</a> bakın.",
    ...
    "We recommend to enable system cron as any other cron method has possible performance and reliability implications." : "Diğer herhangi bir cron yönteminin olası performans ve güvenilirlik etkileri olduğundan sistem cron uygulamasını etkinleştirmenizi öneririz.",
    ...
    "Use them as a security measure to hide your actual password which you may only want to use for web interface login." : "Bunları, yalnızca web arayüzü girişi için kullanmak isteyebileceğiniz gerçek parolanızı gizlemek için bir güvenlik önlemi olarak kullanın.",
    ...
    "Admin" : "Yönetici",
    "Other" : "Diğer",
    "No panels for this section." : "Bu bölüm için bir panel yok.",
