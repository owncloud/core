OC.L10N.register(
    ...
    "Select a profile picture" : "تحديد صورة الملف الشخصي",
    ...
    "Administrator documentation" : "مستندات المسؤول",
    "Developer documentation" : "مستندات المطور",
    "Online documentation" : "مستندات عبر الإنترنت",
    "Forum" : "منتدى",
    "Issue tracker" : "متعقب المشكلة",
    ...
    "Log" : "تسجيل",
    "What to log" : "المحتوى المُراد تسجيل",
    ...
    "Your database does not run with \"READ COMMITED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "لا تعمل قاعدة بياناتك مع \"READ COMMITED\" مستوى عزل المعاملة. ويؤدي ذلك إلى حدوث مشكلات عند تنفيذ إجراءات متعددة في الوقت نفسه.",
    ...
    "If your installation is not installed in the root of the domain and uses system cron, there can be issues with the URL generation. To avoid these problems, please set the \"overwrite.cli.url\" option in your config.php file to the webroot path of your installation (Suggested: \"%s\")" : "إذا لم يتم تثبيت تثبيتك في جذر المجال واستخدم كرون النظام، يمكن أن تحدث بعض المشكلات في إنشاء عنوان URL. ولتجنب هذه المشكلات، يُرجى تعيين خيار \"overwrite.cli.url\" في ملف config.php على مسار webroot للتثبيت (مقترح: \"%s\")",
    ...
    "Admin" : "المسؤول",
    "Other" : "آخر",
    "No panels for this section." : "لا توجد لوحات لهذا القسم.",
