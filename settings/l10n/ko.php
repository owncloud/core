...
"Last Login" => "마지막 로그인",
"Search Users and Groups" => "사용자 또는 그룹 검색",
"Add Group" => "그룹 추가",
"Everyone" => "모든 사용자",
"Admins" => "관리자",
"Group..."=>"그룹입력",
"Fill in an email address to enable password recovery and receive notifications" => "암호 리셋과 알림을 위해 이메일 주소를 적어주세요",
"Error creating group" => "그룹 추가",
"A valid group name must be provided" => "정확한 그룹 이름을 입력하십시오",
"deleted"=>"삭제완료",
"Allow users to share via link" => "사용자가 링크를 통해 공유하도록 허용",
"Enforce password protection"=>"암호 보호 필수로 지정",
"Set default expiration date" =>"기본 만료 기간 설정",
"Expire after " => "기간 : ",
"days" => "일 후에 만료",
"Enforce expiration date" => "만료일 필수로 지정",
"Restrict users to only share with users in their groups"=>"사용자들은 그들의 그룹 안에서만 공유하도록 제한",
"Allow users to send mail notification for shared files"=>"사용자가 공유된 파일을 위해 메일알림을 보내도록 허용",
"Exclude groups from sharing"=>"선택한 그룹은 공유기능 제외",
);
