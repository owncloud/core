OC.L10N.register(
    ...
    "log-level out of allowed range" : "ระดับของไฟล์บันทึกไม่ได้อยู่ในช่วงที่ได้รับอนุญาต",
    ...
    "APCu" : "APCu",
    "Redis" : "Redis",
    "__language_name__" : "ภาษาไทย - Thai language",
    ...
    "Enforce password protection for read-only shares" : "บังคับใช้การป้องกันด้วยรหัสผ่านสำหรับการแชร์แบบอ่านอย่างเดียว",
    "Enforce password protection for read & write shares" : "บังคับใช้การป้องกันด้วยรหัสผ่านสำหรับการแชร์แบบอ่านและเขียน",
    "Enforce password protection for write-only shares" : "บังคับใช้การป้องกันด้วยรหัสผ่านสำหรับการแชร์แบบเขียนอย่างเดียว",
    ...
    "Unlimited" : "ไม่จำกัด",
    "You are using %s of %s" : "คุณใช้พื้นที่จัดเก็บข้อมูลไปแล้ว %s จากทั้งหมด %s",
    ...
    "App name" : "ชื่อแอพฯ",
    "Create new app password" : "สร้างรหัสผ่านของแอพฯใหม่",
