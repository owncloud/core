OC.L10N.register(
    ...
    "Use the following link to confirm your changes to the email address: {link}" : "ใช้ลิงค์ต่อไปนี้เพื่อยืนยันการเปลี่ยนแปลงของคุณตามที่อยู่อีเมล: {link}",
    ...
    "These are the web, desktop and mobile clients currently logged in to your ownCloud." : "ทั้งหมดนี้เป็นเว็บ คอมพิวเตอร์และสมาร์ทโฟนของผู้ใช้ที่เข้าสู่ระบบใน ownCloud ของคุณ",
    "Browser" : "เบราว์เซอร์",
