OC.L10N.register(
    ...
    "cURL is using an outdated %s version (%s). Please update your operating system or features such as %s will not work reliably." : "คุณกำลังใช้ cURL %s รุ่นเก่ากว่า (%s)โปรดอัปเดตระบบปฏิบัติการหรือคุณสมบัติเป็น %s เพื่อการทำงานที่มีประสิทธิภาพ",
    ...
    "No apps found for your version" : "ไม่พบแอปพลิเคชันสำหรับรุ่นของคุณ",
    ...
    "This app has no minimum ownCloud version assigned. This will be an error in ownCloud 11 and later." : "แอปฯนี้ได้ไม่บ่งบอกรุ่นต่ำสุดของ ownCloud นี้จะเป็นปัญหาใน ownCloud รุ่น 11 และรุ่นต่อไป",
    "This app has no maximum ownCloud version assigned. This will be an error in ownCloud 11 and later." : "แอปฯนี้ได้ไม่บ่งบอกรุ่นสูงสุดของ ownCloud  นี้จะเป็นข้อผิดพลาดใน ownCloud ที่ 11 และรุ่นต่อมา",
    ...
    "%1$s below version %2$s is installed, for stability and performance reasons we recommend updating to a newer %1$s version." : "%1$s เป็นรุ่นที่ต่ำกว่า %2$s ได้ถูกติดตั้ง สำหรับเหตุผลด้านเสถียรภาพและประสิทธิภาพการทำงาน เราขอแนะนำให้อัปเดตไปเป็นรุ่น %1$s",
    ...
    "Help translate" : "แปลภาษาไทยโดย Sunchai Paejaroenchai (YIT)",
