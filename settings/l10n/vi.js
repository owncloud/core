OC.L10N.register(
    ...
    "Domain" : "Tên miền",
    "The new password can not be the same as the previous one" : "Mật khẩu mới không được giống với mật khẩu trước đó",
    "Change" : "Thay đổi",
    "APCu" : "APCu",
    "Official" : "Official",
    "Approved" : "Approved",
    ...
    "Administrator documentation" : "Tài liệu của quản trị viên",
    ...
    "An app password is a passcode that gives an app or device permissions to access your %s account." : "Mật khẩu ứng dụng là mật mã cho phép ứng dụng hoặc thiết bị truy cập vào tài khoản %s của bạn.",
    "No panels for this section." : "Không có điều khiển cho phần này.",
