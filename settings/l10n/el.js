OC.L10N.register(
    ...
    "An email has been sent to this address for confirmation" : "Στάλθηκε μήνυμα στην διεύθυνση αυτή για επιβεβαίωση",
    ...
    "Email changed successfully." : "Η διεύθυνση ηλεκτρονικής αλληλογραφίας άλλαξε επιτυχώς.",
    ...
    "Download logfile (%s)" : "Λήψη αρχείου ιστορικού (%s)",
    ...
    "Your database does not run with \"READ COMMITED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "Η βάση δεδομένων σας δεν λειτουργεί με στάθμη απομόνωσης συναλλαγής «READ COMMITED». Αυτό μπορεί να προκαλέσει προβλήματα όταν πολλαπλές δράσεις εκτελούνται παράλληλα.",
    ...
    "Please double check the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">installation guides ↗</a>, and check for any errors or warnings in the <a href=\"#log-section\">log</a>." : "Παρακαλώ ελέγξτε ξανά τα <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">εγχειρίδια εγκατάστασης ↗</a>,  καθώς επίσης και για τυχόν σφάλματα ή προειδοποιήσεις στο <a href=\"#log-section\">ιστορικό</a>.",
    ...
    "Sessions" : "Συνεδρίες",
    "These are the web, desktop and mobile clients currently logged in to your ownCloud." : "Αυτοί είναι οι πελάτες για το δίκτυο, το σταθερό υπολογιστή και το κινητό που έχουν εισέλθει στο ownCloud.",
    "Browser" : "Περιηγητής",
    ...
    "Name" : "Όνομα",
    "An app password is a passcode that gives an app or device permissions to access your %s account." : "Το συνθηματικό της εφαρμογής είναι ένας κωδικός πρόσβασης που παρέχει στην εφαρμογή ή στην συσκευή το δικαίωμα να έχει πρόσβαση στον λογαριασμό %s.",
    ...
    "Admin" : "Διαχείριση",
    "Error" : "Σφάλμα",
    "No panels for this section." : "Κανένας πίνακας γι' αυτή την ενότητα.",
