OC.L10N.register(
    ...
    "If your installation is not installed in the root of the domain and uses system cron, there can be issues with the URL generation. To avoid these problems, please set the \"overwrite.cli.url\" option in your config.php file to the webroot path of your installation (Suggested: \"%s\")" : "Ако инсталацията ви не е инсталирана в корена на домейна и използва системния cron, има вероятност да възникнат проблеми с генерирането на URL адреси. За да избегнете тези проблеми, моля задайте опцията \"overwrite.cli.url\" във вашия файл config.php към пътя webroot на вашата инсталация (Предложено:: \"%s\")",
