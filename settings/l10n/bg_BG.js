OC.L10N.register(
    ...
    "Allow users to send mail notification for shared files to other users" : "Разрешаване на потребителите да изпращат към други потребители уведомителни писма за споделени файлове.",
