OC.L10N.register(
    ...
    "Set default expiration date for user shares" : "Задаване на дата по подразбиране за изтичане на валидност на потребителските споделяния",
    "Set default expiration date for group shares" : "Задаване по подразбиране на дата за изтичане на валидност на груповите споделяния",
