OC.L10N.register(
    ...
    "Backend doesn't support password change, but the user's encryption key was successfully updated." : "Сървърът не позволява смяна на паролата, но потребителския ключ за криптиране беше успешно актуализиран.",
    ...
    "Couldn't send email address change notification mail. Please contact your administrator." : "Не успешно изпращане на  имейл с известие за промяна на имейл адреса. Моля, свържете се с вашия администратор.",
    ...
    "Error: could not disable broken app" : "Грешка: повреденото приложение не може да се деактивира",
    ...
    "Error while creating device token" : "Грешка при създаване на токен на устройството",
    ...
    "Select default encryption module:" : "Изберете модул за криптиране по подразбиране:",
    ...
    "Start migration" : "Стартиране на мигрирането",
    "Sharing" : "Споделяне",
    "Allow apps to use the Share API" : "Разрешаване на приложенията да използват API Share",
    "Allow users to share via link" : "Разрешаване на потребителите да споделят с връзка",
    ...
    "Enforce password protection for upload-only (File Drop) links" : "Прилагане на защита с парола за връзките, които са само за качване (File Drop)",
    "Set default expiration date" : "Задаване на дата на изтичане по подразбиране",
    ...
    "Language used for public mail notifications for shared files" : "Език, използван за известия по публичната електронна поща за споделени файлове",
    ...
    "Set default expiration date for group shares" : "Задаване на дата по подразбиране на изтичане на валидността на груповите споделяния",
    "Set default expiration date for federated shares" : "Задаване на дата по подразбиране на изтичане на валидността на федеративни споделяния",
    ...
    "Allow users to send mail notification for shared files to other users" : "Разрешаване на потребителите да изпращат уведомителни писма за споделени файлове към други потребители.",
    ...
    "Enable manual file locking in the web interface" : "Активиране на ръчно заключване на файлове в уеб интерфейса",
    ...
    "The Read-Only config has been enabled. This prevents setting some configurations via the web-interface. Furthermore, the file needs to be made writable manually for every update." : "Конфигурацията само за четене е активирана. Това предотвратява настройването на някои конфигурации чрез уеб интерфейса. Освен това файлът трябва ръчно да бъде направен записваем за всяка актуализация.",
    ...
    "If your installation is not installed in the root of the domain and uses system cron, there can be issues with the URL generation. To avoid these problems, please set the \"overwrite.cli.url\" option in your config.php file to the webroot path of your installation (Suggested: \"%s\")" : "Ако инсталацията ви не е инсталирана в корена на домейна и използва системния cron, има вероятност да възникнат проблеми с генерирането на URL. За да избегнете тези проблеми, моля задайте опцията \"overwrite.cli.url\" във вашия файл config.php към пътя webroot на вашата инсталация (Предлага се: \"%s\")",
    "SQLite is used as database. For larger installations we recommend to switch to a different database backend." : "Като база данни се използва SQLite. За по-големи инсталации препоръчваме да се премине към друга база данни.",
    ...
    "Password" : "Парола",
    "Unable to change your password" : "Неуспешна промяна на паролата ви",
    ...
    "Name" : "Име",
    "App passwords or tokens are passcodes that give an app or device permissions to access your %s account." : "Паролите за приложения или токените са пароли, които дават на дадено приложение или устройство разрешения за достъп до вашия %s профил.",
    ...
    "Create new app passcode" : "Създаване на нов код за достъп на приложението",
    ...
    "Show user backend" : "Показване на потребителската задна част - backend",
    ...
    "User Backend" : "Потребителска задна част - backend",
