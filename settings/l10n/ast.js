OC.L10N.register(
    ...
    "_You have %n app update pending_::_You have %n app updates pending_" : ["Ties %n anovamientu d'aplicación pendiente","Ties %n anovamientos d'aplicaciones pendientes"],
    ...
    "Your server is running on Microsoft Windows. We highly recommend Linux for optimal user experience." : "El to servidor s'executa en Microsoft Windows. Encamentamoste Linux pa una esperiencia d'usuariu óptima.",
    ...
    "Experimental applications ahead" : "Aplicaciones esperimentales per delantre",
    "Experimental apps are not checked for security issues, new or known to be unstable and under heavy development. Installing them can cause data loss or security breaches." : "Les aplicaciones esperimentales nun son comprobaes por cuestiones de seguridá, nueves o conocíes por ser inestables . La so instalación puede causar perda de datos o violaciones de seguridá.",
    "by %s" : "por %s",
    ...
    "This app has an update available." : "L'aplicación tien un anovamientu disponible.",
    ...
    "Enable experimental apps" : "Habilitar aplicaciones esperimentales",
    ...
    "If you want to support the project\n\t\t<a href=\"https://owncloud.org/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">join development</a>\n\t\tor\n\t\t<a href=\"https://owncloud.org/promote\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">spread the word</a>!" : "Si quies sofitar el proyeutu\n⇥⇥<a href=\"https://owncloud.org/contribute\"\n⇥⇥⇥target=\"_blank\" rel=\"noreferrer\">xúnite al desendolcu</a>\n⇥⇥o\n⇥⇥<a href=\"https://owncloud.org/promote\"\n⇥⇥⇥target=\"_blank\" rel=\"noreferrer\">¡espardi la pallabra!</a>",
