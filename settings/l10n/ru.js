OC.L10N.register(
    ...
    "Enforce password protection for read-only shares" : "Принудительно защищать паролем доступ только для чтtybz",
    "Enforce password protection for read & write shares" : "Принудительно защищать паролем доступ на чтение и запись",
    "Enforce password protection for write-only shares" : "Принудительно защищать паролем доступ только на запись",
