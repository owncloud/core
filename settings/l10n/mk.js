OC.L10N.register(
    ...
    "App passwords" : "Лозинка за апликации",
    "You've linked these apps." : "Ги поврзавте овие апликации.",
    "Name" : "Име",
    "An app password is a passcode that gives an app or device permissions to access your %s account." : "Лозинката за апликација е код за пристап кој дава дозволи за апликација или уред за пристап до вашата %s сметка.",
