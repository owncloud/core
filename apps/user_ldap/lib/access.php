...
class Access extends LDAPUtility {
	 ...
	 * @return boolean so true, otherwise false
	 */
	 ...
	 * @param $name the display name of the object
	 * @param boolean $isUser boolean, whether name should be created for a user (true) or a group (false)
	 * @returns string with with the name to use in ownCloud or false if unsuccessful
	 */
	 ...
	 * @return boolean|null on success, null or false otherwise
	 */
