	...
	<fieldset id="ldapSettings-1">
		<div id="ldapAdvancedAccordion">
			...
			<div>
				...
				<p><label for="ldap_turn_on_pwd_change"><?php p($l->t('Enable LDAP password changes per user.'));?></label><input type="checkbox" id="ldap_turn_on_pwd_change" name="ldap_turn_on_pwd_change" title="<?php p($l->t('Allow LDAP users to change their password. Only works when access control policies are configured accordingly on the LDAP server.', $theme->getName() ));?>" data-default="<?php p($_['ldap_turn_on_pwd_change_default']); ?>" value="0"><br/></p>
			</div>
