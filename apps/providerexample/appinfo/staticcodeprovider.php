...
class StaticCodeProvider implements IProvider {
	...
	public function getAuthenticationHtml() {
		return '<p>To login please enter the code "0815".</p><form method="POST"><input type="text" name="response" /><input type="hidden" name="requesttoken" value="' . Util::callRegister() . '"/><input type="submit"></form>';
	}
