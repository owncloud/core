OC.L10N.register(
    ...
    "Error occurred while updating comment with id {id}" : "Prišlo je do napake med med posodabljanjem opombe z ID {id}",
    "Error occurred while posting comment" : "Prišlo je do napake med objavljanjem opombe",
