...
class Google_Service_Document_Resource_Uiv1beta3ProjectsLocationsOperations extends Google_Service_Resource
{
   ...
   */
  public function cancelOperation($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('cancelOperation', array($params), "Google_Service_Document_GoogleProtobufEmpty");
  }
  /**
   ...
   */
  public function listUiv1beta3ProjectsLocationsOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
