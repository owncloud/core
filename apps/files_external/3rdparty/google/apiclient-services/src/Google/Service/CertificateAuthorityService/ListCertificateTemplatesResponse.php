...
class Google_Service_CertificateAuthorityService_ListCertificateTemplatesResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  protected $certificateTemplatesType = 'Google_Service_CertificateAuthorityService_CertificateTemplate';
  protected $certificateTemplatesDataType = 'array';
  public $nextPageToken;
  public $unreachable;

  /**
   * @param Google_Service_CertificateAuthorityService_CertificateTemplate[]
   */
