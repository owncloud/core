 ...
 *  </code>
 */
class Google_Service_Firebaseappcheck_Resource_ProjectsServices extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaBatchUpdateServicesResponse
   */
  public function batchUpdate($parent, Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('batchUpdate', array($params), "Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaBatchUpdateServicesResponse");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaService
   */
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaService");
  }
  /**
   ...
   * @return Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaListServicesResponse
   */
  public function listProjectsServices($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaListServicesResponse");
  }
  /**
   ...
   * Database)
   * @param Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaService $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaService
   */
  public function patch($name, Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaService $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaService");
  }
}
