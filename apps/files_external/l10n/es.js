OC.L10N.register(
    ...
    "An error occured while adding the external storage, please check the logs or contact the administrator" : "Ocurrió un error al agregar el almacenamiento externo, verifique los registros o comuníquese con el administrador",
    "External storage has been added successfully" : "El almacenamiento externo ha sido añadido con éxito",
    "An error occured while adding the external storage please check the logs" : "Ocurrió un error al agregar el almacenamiento externo, verifique los registros",
    "Saved" : "Guardado",
