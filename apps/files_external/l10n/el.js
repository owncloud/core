OC.L10N.register(
    ...
    "Some of the configured external mount points are not connected. Please click on the red row(s) for more information" : "Μερικά εξωτερικά σημεία προσάρτησης που έχουν ρυθμιστεί δεν είναι συνδεδεμένα. Παρακαλώ κάντε κλικ στην κόκκινη γραμμή(ές) για περισσότερες πληροφορίες",
    "Please enter the credentials for the {mount} mount" : "Παρακαλώ εισάγετε τα διαπιστευτήρια για το προσαρτημένο {mount}",
    ...
    "%s" : "%s",
    "Storage with id \"%i\" is not user editable" : "Ο χρήστης δεν μπορεί να επεξεργαστεί τον αποθηκευτικό χώρο με αναγνωριστικό \"%i\".",
    ...
    "Enable external storage" : "Ενεργοποίηση εξωτερικού αποθηκευτικού χώρου",
    "External storage has been disabled by the administrator" : "Ο εξωτερικός αποθηκευτικός χώρος έχει απενεργοποιηθεί από τον διαχειριστή",
