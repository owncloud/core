...
class ApplicableControllerTest extends \Test\TestCase {
	...
	private function createMockUser($uid, $displayname) {
	...
	private function createMockGroup($gid, $displayname) {
	...
	public function patternSearchProvider() {
		return [
			['', null, null],
			['', null, 44],
			['', 17, null],
	 ...
	 */
	public function testPatternSearch($pattern, $limit, $offset) {
	...
	public function testUserDisplayName() {
		$user1 = $this->createMockUser('U1122', 'Joe Joe Jones');
		$user2 = $this->createMockUser('U1322', 'Mary Sue');
