...
class OC_Mount_Config {
	...
	public static function getAbsoluteMountPoints($uid) {
		...
		foreach ($userGlobalStoragesService->getAllStorages() as $storage) {
			...
			$mountPoints[$mountPoint] = self::prepareMountPointEntry($storage, false);
	...
	private static function prepareMountPointEntry(StorageConfig $storage, $isPersonal) {
		$mountEntry = [];
		$mountEntry['class'] = $mountEntry['backend'] = $storage->getBackend()->getIdentifier();
