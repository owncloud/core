OC.L10N.register(
    ...
    "Directory \"{dir}\" is unavailable, please contact the administrator" : "\"{dir}\" dizini kullanılabilir değil, lütfen yöneticiniz ile iletişime geçin",
    "Storage for \"{dir}\" is temporarily not available" : "\"{dir}\" için depolama alanı geçici olarak kullanılamıyor",
    "Shared directory \"{dir}\" is not available, remove the share or contact it's owner to reshare." : "\"{dir}\" paylaşılan dizini kullanılamıyor, paylaşımı kaldırın veya yeniden paylaşmak için sahibiyle iletişime geçin.",
    "Directory \"{dir}\" not found" : "\"{dir}\" dizini bulunamadı",
    "group" : "grup",
    ...
    "Failed to lock." : "Kilitleme başarısız.",
    "This resource is locked. Click to see more details." : "Bu kaynak kilitli. Daha fazla ayrıntı görmek için tıklayın.",
    "Encountered problem accessing the folder {name}" : "{name} klasörüne erişilirken sorunla karşılaşıldı",
    ...
    "A file or folder has been <strong>renamed</strong>" : "Bir dosya veya klasör <strong>yeniden adlandırıldı</strong>",
    "A file or folder has been <strong>moved</strong>" : "Bir dosya veya klasör <strong>taşındı</strong>",
    ...
    "%1$s was deleted due to automation rule" : "%1$s otomasyon kuralı nedeniyle silindi",
    ...
    "You renamed %2$s to %1$s" : "%2$s'yi %1$s olarak yeniden adlandırdınız",
    "%2$s renamed %3$s to %1$s" : "%2$s, %3$s'yi %1$s olarak yeniden adlandırdı  ",
    "You moved %2$s to %1$s" : "%2$s'i %1$s'ye taşıdınız",
    "%2$s moved %3$s to %1$s" : "%2$s, %3$s'yi %1$s'e taşıdı",
    ...
    "You moved this file to %1$s" : "Bu dosyayı %1$s'ye taşıdınız",
    "%2$s moved this file to %1$s" : "%2$s, bu dosyayı %1$s'e taşıdı",
