OC.L10N.register(
    ...
    "Close" : "إغلاق",
    "Favorites" : "المفضلة ",
    "Upload timeout for file \"{file}\"" : "انتهى زمن تحميل الملف \"{file}\"",
    "Unknown error \"{error}\" uploading file \"{file}\"" : "خطأ غير معروف \"{error}\" تحميل الملف \"{file}\"",
    ...
    "Could not move \"{file}\": {message}" : "تعذر نقل \"{file}\": {message}",
    ...
    "_including %n hidden_::_including %n hidden_" : ["يحتوي %n  مخفي","يحتوي %n مخفي","يحتوي %n مخفي","يحتوي %n مخفي","يحتوي %n مخفي","يحتوي %n مخفي"],
    ...
    "\"{name}\" has a forbidden file type/extension." : "امتداد الملف \"{name}\" محظور.",
    ...
    "Path" : "المسار",
    "_%n byte_::_%n bytes_" : ["%nبايت","%nبايت","%nبايت","%nبايت","%nبايت","%n بايت"],
    ...
    "Upload (max. %s)" : "الرفع ( الحد الأقصى. %s ) ",
    "Settings" : "إعدادات",
    "Show hidden files" : "عرض الملفات المخفية",
    "WebDAV" : "ويب داف (WebDAV)",
