OC.L10N.register(
    ...
    "..." : "...",
    "{hours}:{minutes}:{seconds} hour{plural_s} left" : "{hours}:{minutes}:{seconds} preostalo",
    "{hours}:{minutes}h" : "{hours}:{minutes}h",
    "{minutes}:{seconds} minute{plural_s} left" : "{minutes}:{seconds} preostalo",
    "{minutes}:{seconds}m" : "{minutes}:{seconds}min",
    "{seconds} second{plural_s} left" : "{seconds} preostalo",
    "{seconds}s" : "{seconds}s",
