OC.L10N.register(
    ...
    "The file {file} already exists" : "Soubor {file} již existuje",
    ...
    "Lock status" : "Stav zámku",
    "Lock file" : "Zamknout soubor",
    "Failed to lock." : "Chyba v zamykání",
    "\"{name}\" is an invalid file name." : "\"{name}\" je neplatným názvem souboru.",
    "File name cannot be empty." : "Název souboru nemůže být prázdný řetězec.",
    "File name cannot contain \"/\"." : "Název souboru nemůže obsahovat znak \"/\"",
    ...
    "You renamed %2$s to %1$s" : "Přejmenoval(a) jsi %2$s na %1$s",
