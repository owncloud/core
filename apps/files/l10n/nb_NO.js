OC.L10N.register(
    ...
    "..." : "...",
    "{hours}:{minutes}:{seconds} hour{plural_s} left" : "{hours}:{minutes}:{seconds} timer igjen",
    "{hours}:{minutes}h" : "{hours}:{minutes}t",
    "{minutes}:{seconds} minute{plural_s} left" : "{minutes}:{seconds} minutter igjen",
    "{minutes}:{seconds}m" : "{minutes}:{seconds}m",
    "{seconds} second{plural_s} left" : "{seconds} sekunder igjen",
    "{seconds}s" : "{seconds}s",
