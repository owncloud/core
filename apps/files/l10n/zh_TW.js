OC.L10N.register(
    ...
    "Directory \"{dir}\" is unavailable, please contact the administrator" : "資料夾\"{dir}\"不可用，請聯繫管理員",
    "Storage for \"{dir}\" is temporarily not available" : "儲存空間\"{dir}\" 暫時不可用的",
    "Shared directory \"{dir}\" is not available, remove the share or contact it's owner to reshare." : "已分享的資料夾 \"{dir}\" 可用的移除分享或聯繫它的所有者以分享。",
    "Directory \"{dir}\" not found" : "資料夾 \"{dir}\" 未找到",
    "group" : "群組",
    ...
    "%1$s was deleted due to automation rule" : "%1$s由於自動化規則被刪除",
