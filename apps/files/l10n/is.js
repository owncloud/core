OC.L10N.register(
    ...
    "Failed to upload the file \"{fileName}\": {error}" : "Tókst ekki að senda inn \"{fileName}\": {error}",
    "Uploading..." : "Sendi inn ...",
    "..." : "...",
    ...
    "How do you want to open this file?" : "Hvernig viltu opna þessa skrá?",
    ...
    "Directory \"{dir}\" is unavailable, please contact the administrator" : "Mappan \"{dir}\" er ekki aðgengileg, hafðu samband við kerfisstjóra",
    "Storage for \"{dir}\" is temporarily not available" : "Gagnageymsla fyrir \"{dir}\" er ekki aðgengileg í bili",
    "Shared directory \"{dir}\" is not available, remove the share or contact it's owner to reshare." : "Deild mappa \"{dir}\" er ekki til, fjarlægðu deilinguna eða hafðu samband við eiganda til að endurdeila.",
    "Directory \"{dir}\" not found" : "Mappan \"{dir}\" fannst ekki",
    "group" : "hópur",
    ...
    "Lock file" : "Læsa skrá",
    "Failed to lock." : "Gat ekki læst.",
    "This resource is locked. Click to see more details." : "Þetta tilfang er læst. Smelltu til að sjá frekari upplýsingar.",
    "Encountered problem accessing the folder {name}" : "Lenti í vandræðum með aðgang að möppu {name}",
    ...
    "A file or folder has been <strong>renamed</strong>" : "Skrá eða mappa hefur verið <strong>endurnefnd</strong>",
    "A file or folder has been <strong>moved</strong>" : "Skrá eða mappa hefur verið <strong>flutt</strong>",
    ...
    "%1$s was deleted due to automation rule" : "%1$s var eytt vegna sjálfvirkrar reglu",
    "%2$s deleted %1$s" : "%2$s eyddi %1$s",
    "You restored %1$s" : "Þú endurheimtir %1$s",
    "%2$s restored %1$s" : "%2$s endurheimti %1$s",
    "You renamed %2$s to %1$s" : "Þú endurnefndir %2$s í %1$s",
    "%2$s renamed %3$s to %1$s" : "%2$s endurnefnd %3$s í %1$s",
    "You moved %2$s to %1$s" : "Þú fluttir %2$s í %1$s",
    "%2$s moved %3$s to %1$s" : "%2$s fluttir %3$s í %1$s",
    "Changed by %2$s" : "Breytt af %2$s",
    "Deleted by %2$s" : "Eytt af %2$s",
    "Restored by %2$s" : "Endurheimt af %2$s",
    "You moved this file to %1$s" : "Þú færðir þessa skrá í %1$s",
    "%2$s moved this file to %1$s" : "%2$s færðir þessa skrá í %1$s",
