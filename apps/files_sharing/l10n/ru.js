OC.L10N.register(
    ...
    "User \"%1$s\" shared \"%3$s\" with you (on behalf of \"%2$s\")" : "Пользователь \"%1$s\" предоставил вам доступ к \"%3$s\" (от имени \"%2$s\")",
    "User \"%1$s\" shared \"%3$s\" with you" : "Пользователь \"%1$s\" предоставил вам доступ к \"%3$s\"",
    "Accept" : "Принять",
    "Decline" : "Отклонить",
