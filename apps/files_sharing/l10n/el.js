OC.L10N.register(
    ...
    "You removed the share of %2$s for %1$s" : "Έχετε μετακινήσει το διαμοιρασμό του %2$s σε  %1$s",
    "%2$s removed the share of %3$s for %1$s" : "Ο διαμοιρασμός του %2$s έχει μετακινηθεί από %3$s σε %1$s",
    ...
    "You removed the share of group %2$s for %1$s" : "Έχετε μετακινήσει το διαμοιρασμό μεταξύ της ιδίας ομαδας απο %2$s σε %1$s",
