OC.L10N.register(
    ...
    "Not allowed to create a federated share with the same user server" : "Δεν είναι επιτρεπτή η δημιουργία ομόσπονδου διαμοιρασμού με τον ίδιο διακομιστή χρήστη",
    ...
    "Click to select files or use drag & drop to upload" : "Κάντε κλικ για να επιλέξετε αρχεία ή χρησιμοποιήστε drag & drop για μεταφόρτωση",
    "Uploaded files" : "Μεταφόρτωση αρχείων",
    ...
    "%1$s unshared %2$s from you" : "Ο %1$s αναίρεσε το διαμοιρασμό του %2$s με εσάς",
    ...
    "%2$s removed the share of %3$s for %1$s" : "Ο %2$s έχει αφαιρέσει τον διαμοιασμό του %3$s για %1$s",
    ...
    "%2$s removed the public link for %1$s" : "Ο %2$s αφαίρεση τον δημόσιο σύνδεσμο για %1$s",
    ...
    "%2$s removed the share for %1$s" : "Ο %2$s αφαίρεση το κοινόχρηστο για %1$s",
    ...
    "%2$s removed share of group %3$s" : "Ο/Η %2$s κατήργησε την κοινή χρήση της ομάδας %3$s",
    ...
    "%2$s removed public link" : "Ο/Η %2$s κατήργησε τον δημόσιο σύνδεσμο",
    ...
    "Cannot remove all permissions" : "Δεν είναι δυνατή η κατάργηση όλων των δικαιωμάτων",
    "Please specify a valid user" : "Παρακαλώ καθορίστε έγκυρο χρήστη",
    "Group sharing is disabled by the administrator" : "O διαμοιρασμός μεταξύ της ιδίας ομάδας έχει απενεργοποιηθεί από το διαχειρηστή",
