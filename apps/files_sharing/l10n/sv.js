OC.L10N.register(
    ...
    "Remote is unreachable" : "Fjärrservern kan inte nås",
    "Could not authenticate to federated share, password might be wrong" : "Kunde inte autentisera till den federerade delningen, lösenordet kan vara fel",
    "Storage not valid" : "Lagring ej giltig",
    "Couldn't add federated share" : "Kunde inte lägga till federerad delning",
    ...
    "An error occurred while updating share state: {message}" : "Ett fel uppstod när delningsstatusen uppdaterades: {message}",
    "Accept Share" : "Acceptera delning",
    "Decline Share" : "Avböj delning",
    "Do you want to add the federated share {name} from {owner}@{remote}?" : "Vill du lägga till den federerade delningen {name} från {owner}@{remote}?",
    "Federated share" : "Federerad delning",
    "Federated share password" : "Lösenord för federerad delning",
    "Cancel" : "Avbryt",
    "Add federated share" : "Lägg till federerad delning",
    "The video cannot be played because your browser does not support the file type. Please try another browser." : "Videon kan inte spelas upp eftersom webbläsaren inte stöder filtypen. Prova en annan webbläsare.",
    "You can upload into this folder" : "Du kan ladda upp i denna map",
    "Add to another cloud" : "Lägg till i ett annat moln",
    "Enter the server address to add the content to" : "Ange serveradressen som innehållet ska läggas till på",
    "Add" : "Lägg till",
    ...
    "Create and copy public link" : "Skapa och kopiera publik länk",
    "Public quick link" : "Publik snabblänk",
    "Public link has been copied to the clipboard." : "Den publika länken har kopierats till urklipp.",
    "A new public link with download & view permissions has been created and copied to the clipboard." : "En ny publik länk med behörighet att ladda ned och visa har skapats och kopierats till urklipp.",
    "The public link could not be created. Please contact the administrator for help." : "Den publika länken kunde inte skapas. Kontakta administratören för hjälp.",
    ...
    "You received a new federated share %2$s from %1$s" : "Du har fått en ny federerad delning, %2$s, från %1$s",
    "You received a new federated share from %s" : "Du har fått en ny federerad delning från %s",
    "%1$s accepted federated share %2$s" : "%1$s accepterade den federerade delningen %2$s",
    "%1$s declined federated share %2$s" : "%1$s avböjde den federerade delningen %2$s",
    ...
    "You unshared %1$s shared by %2$s from self" : "Du tog bort delningen av %1$s, som delats av %2$s, från dig själv",
    ...
    "The share for %1$s expired" : "Delningen för %1$s har löpt ut",
    ...
    "Unshared %1$s from self" : "Delning av %1$s togs bort från dig själv",
    ...
    "Received federated share from %1$s" : "Tog emot federerad delning från %1$s",
    "Received federated share from %s" : "Tog emot federerad delning från %s",
    "Shares" : "Delningar",
    "File sharing" : "Fildelning",
    "Public link" : "Publik länk",
    "Couldn't send mail to following recipient(s): %s " : "Kunde inte skicka e-post till följande mottagare: %s ",
    "Share API is disabled" : "Dela-API är inaktiverat",
    "Wrong share ID, share doesn't exist" : "Fel delningsid, delning existerar inte",
    "Share points to a node not available" : "Delningen pekar på en nod som inte är tillgänglig",
    ...
    "The group is blacklisted for sharing" : "Gruppen finns på spärrlistan för delning",
    "Public link sharing is disabled by the administrator" : "Publik länkdelning är inaktiverat av administratören",
    "Public link creation is only possible for certain groups" : "Endast vissa grupper kan skapa publika länkar",
    ...
    "shareWith parameter must be a string" : "Parametern shareWith måste vara en sträng",
    "Unknown share type" : "Okänd delningstyp",
    "Could not lock path" : "Kunde inte låsa sökväg",
    "Not a directory" : "Inte en mapp",
    "Could not update share" : "Kunde inte uppdatera delningen",
    "Can't change permissions for public share links" : "Kan inte ändra rättigheter på publika delningslänkar",
    "Only recipient can change accepted state" : "Endast mottagaren kan ändra godkännandestatusen",
    ...
    "Allow finding you via autocomplete in share dialog. If this is disabled the full username needs to be entered." : "Tillåt att du hittas via automatisk komplettering i delningsdialogen. Om detta inaktiveras måste hela användarnamnet anges.",
    ...
    "Group Sharing Blacklist" : "Spärrlista för gruppdelning",
    "Exclude groups from receiving shares" : "Undanta grupper från att ta emot delningar",
    "These groups will not be available to share with. Members of the group are not restricted in initiating shares and receiving personal shares/invitations. Furthermore they can receive shares addressed to other groups they are members of as usual." : "Dessa grupper kommer inte att vara tillgängliga att dela med. Gruppmedlemmar begränsas inte när de inleder delningar eller tar emot personliga delningar/inbjudningar. Dessutom kan de som vanligt ta emot delningar som är adresserade till andra grupper som de är medlemmar i.",
    "Only certain groups are allowed to create public links" : "Endast vissa grupper får skapa publika länkar"
},
