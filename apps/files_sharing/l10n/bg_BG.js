OC.L10N.register(
    ...
    "Couldn't add federated share" : "Не може да се добави федеративно споделяне",
    ...
    "The public link could not be created. Please contact the administrator for help." : "Публичната връзка не може да бъде създадена. Моля, свържете се с администратор за помощ.",
    "No expiration date set" : "Не е определен срок на валидност",
    "Declined" : "Отхвърляне",
    "Pending" : "Чакащо",
    ...
    "%1$s accepted federated share %2$s" : "%1$s прието е федеративно споделяне %2$s",
    "%1$s declined federated share %2$s" : "%1$s отказано е федеративно споделяне %2$s",
    ...
    "You unshared %1$s shared by %2$s from self" : "Вие прекратихте споделеното %1$s, споделено от %2$s със себе си",
    ...
    "You shared %1$s via link" : "Вие споделихте %1$s чрез връзка.",
    ...
    "Received federated share from %1$s" : "Получено федеративно споделяне от %1$s",
    "Received federated share from %s" : "Получено федеративно споделяне от %s",
    "Shares" : "Споделени",
    "File sharing" : "Споделяне на файл",
    "Public link" : "Публичнa връзкa",
    "Couldn't send mail to following recipient(s): %s " : "Неуспешно изпращане на имейл до следният получател(и): %s",
    "Share API is disabled" : "API за споделяне е деактивирано",
    ...
    "Could not update share" : "Неуспешна актуализация на споделянето",
    ...
    "Expiration date" : "Дата на изтичане на валидността",
