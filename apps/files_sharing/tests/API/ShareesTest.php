	...
	public function dataGetGroups() {
		return [
			...
			[
				...
				[],
				[],
				[['label' => 'test1', 'value' => ['shareType' => Share::SHARE_TYPE_GROUP, 'shareWith' => ['test1','test1']]]],
				true,
				false,
			],
			...
			[
				...
				[],
				[],
				[['label' => 'Test One', 'value' => ['shareType' => Share::SHARE_TYPE_GROUP, 'shareWith' => ['test1','Test One']]]],
				true,
				false,
			],
			...
			[
				...
				[],
				[
					['label' => 'test0', 'value' => ['shareType' => Share::SHARE_TYPE_GROUP, 'shareWith' => ['test0','test0']]],
					['label' => 'test1', 'value' => ['shareType' => Share::SHARE_TYPE_GROUP, 'shareWith' => ['test1','test1']]],
				],
				false,
				null,
