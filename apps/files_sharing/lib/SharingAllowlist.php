...
/**
 * Class to handle a allowlist for sharing. The main functionality is to check if a particular group
 * is in allowlist for public sharing, which means that only users of a allowlist should be able to create public shares.
 *
