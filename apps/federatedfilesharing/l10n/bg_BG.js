OC.L10N.register(
    ...
    "Accept" : "Приемам",
    "Decline" : "Отказвам",
    "Share with me through my #ownCloud Federated Cloud ID, see %s" : "Споделяне с мен чрез моето ID в #ownCloud Федеративен облак, вижте %s",
    "Share with me through my #ownCloud Federated Cloud ID" : "Споделете с мен чрез моя #ownCloud Federated Cloud ID",
