OC.L10N.register(
    ...
    "You received \"/%3$s\" as a remote share from %1$s (on behalf of %2$s)" : "Λάβατε το \"/%3$s\" ως απομακρυσμένο διαμοιρασμό από %1$s (εκ μέρους του %2$s)",
    "You received \"/%3$s\" as a remote share from %1$s" : "Λάβατε το  \"/%3$s\"  ως απομακρυσμένο διαμοιρασμό από  %1$s",
    "Accept" : "Αποδοχή",
    "Decline" : "Απόρριψη",
