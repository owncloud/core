...
class FileNotification extends Notification {
	public const NOTIFICATION_TYPE_SHARE_ACCEPTED = 'SHARE_ACCEPTED';
	public const NOTIFICATION_TYPE_SHARE_DECLINED = 'SHARE_DECLINED';
	public const NOTIFICATION_TYPE_SHARE_UNSHARED = 'SHARE_UNSHARED';
	public const NOTIFICATION_TYPE_REQUEST_RESHARE = 'REQUEST_RESHARE';
	public const NOTIFICATION_TYPE_RESHARE_UNDO = 'RESHARE_UNDO';
	public const NOTIFICATION_TYPE_RESHARE_CHANGE_PERMISSION = 'RESHARE_CHANGE_PERMISSION';
