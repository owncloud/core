$(document).ready(function () {
	$('#header #details').prepend(
		...
		'<div id="expanddiv">' +
		'<ul>' +
		'<li><a id="current-server" href="#"><span class="icon icon-checkmark-white"></span>' + OC.getHostName() + '</a></li>' +
		'<li><a id="change-server" href="#"><span class="icon icon-more-white"></span>' +
