...
<form id="sso-auth-form" action="<?php p(\OC::$server->getURLGenerator()->linkToRoute('sso_auth.config.save')); ?>" method="post" autocapitalize="none">
    ...
    <fieldset id="admin-sso-fieldset">
        ...
        <p>
            ...
            <input type="text" name="sso_url" id="sso_url" placeholder="<?php p($l->t('Enter sso url')); ?>"
            ...
            <input type="text" name="realm" id="realm" placeholder="<?php p($l->t('Enter realm')); ?>"
                value="<?php p($_['realm']); ?>" autocomplete="off" autocorrect="off" autofocus />
            ...
            <input type="text" name="client_id" id="client_id" placeholder="<?php p($l->t('Enter client id')); ?>"
                value="<?php p($_['client_id']); ?>" autocomplete="off" autocorrect="off" autofocus />
