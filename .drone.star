	...
	'acceptance': {
		...
		'webUI': {
			'suites': {
				...
				'webUISharingAutocompletion': 'webUISharingAutocomp',
				'webUISharingInternalGroups': 'webUISharingIntGroup',
				'webUISharingInternalUsers': 'webUISharingIntUsers',
				'webUISharingPublic': '',
				'webUITags': '',
				'webUITrashbin': '',
				'webUIUpload': '',
		...
		'webUIFederation': {
			'suites': {
				'webUISharingExternal': 'webUISharingExt',
			},
			'federatedServerNeeded': True,
			'federatedServerVersions': ['daily-master-qa', '10.2.1']
		},
