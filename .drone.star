	...
	if dbName == 'oracle':
		return [{
			...
			'commands': [
				...
				'echo "SHOW PARAMETER FILESYSTEMIO_OPTIONS;" | sqlplus system/oracle ',
				'echo "SHOW PARAMETER DISK_ASYNCH_IO;" | sqlplus system/oracle',
				'echo "ALTER SYSTEM SET FILESYSTEMIO_OPTIONS=DIRECTIO SCOPE=SPFILE;" | sqlplus system/oracle',
				'echo "ALTER SYSTEM SET DISK_ASYNCH_IO=FALSE SCOPE=SPFILE" | sqlplus system/oracle',
