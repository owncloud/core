...
local pipelines = [
  ...
  for matrix in [
    { suite: 'apiMain', notification: false, email: false, federated: '' },
    { suite: 'apiAuth', notification: false, email: false, federated: '' },
    { suite: 'apiAuthOcs', notification: false, email: false, federated: '' },
    { suite: 'apiCapabilities', notification: false, email: false, federated: '' },
    { suite: 'apiComments', notification: false, email: false, federated: '' },
    { suite: 'apiFavorites', notification: false, email: false, federated: '' },
    { suite: 'apiFederation', notification: false, email: false, federated: 'daily-master-qa' },
    { suite: 'apiFederation', notification: false, email: false, federated: '10.2.1' },
    { suite: 'apiProvisioning-v1', notification: false, email: false, federated: '' },
    { suite: 'apiProvisioning-v2', notification: false, email: false, federated: '' },
    { suite: 'apiProvisioningGroups-v1', notification: false, email: false, federated: '' },
    { suite: 'apiProvisioningGroups-v2', notification: false, email: false, federated: '' },
    { suite: 'apiSharees', notification: false, email: false, federated: '' },
    { suite: 'apiShareManagement', notification: false, email: false, federated: '' },
    { suite: 'apiShareManagementBasic', notification: false, email: false, federated: '' },
    { suite: 'apiShareOperations', notification: false, email: false, federated: '' },
    { suite: 'apiShareReshare', notification: false, email: false, federated: '' },
    { suite: 'apiShareUpdate', notification: false, email: false, federated: '' },
    { suite: 'apiSharingNotifications', notification: true, email: false, federated: '' },
    { suite: 'apiTags', notification: false, email: false, federated: '' },
    { suite: 'apiTrashbin', notification: false, email: false, federated: '' },
    { suite: 'apiVersions', notification: false, email: false, federated: '' },
    { suite: 'apiWebdavLocks', notification: false, email: false, federated: '' },
    { suite: 'apiWebdavLocks2', notification: false, email: false, federated: '' },
    { suite: 'apiWebdavMove', notification: false, email: false, federated: '' },
    { suite: 'apiWebdavOperations', notification: false, email: false, federated: '' },
    { suite: 'apiWebdavProperties', notification: false, email: false, federated: '' },
    { suite: 'apiWebdavUpload', notification: false, email: false, federated: '' },
  ]
] + [
  #
  # acceptance cli
  ...
  for matrix in [
    ...
    { suite: 'webUISharingExternal', notification: false, email: true, federated: '10.2.1' },
