OC.L10N.register(
    ...
    "Failed to upload the file \"{fileName}\": {error}" : "Het uploaden van het bestand \"{fileName}\" is mislukt: {error}",
    "Uploading..." : "Uploading...",
    "..." : "...",
    "{loadedSize} of {totalSize} ({bitrate})" : "{loadedSize} van {totalSize} ({bitrate})",
    "Error when assembling chunks, status code {status}" : "Fout bij het samenstellen van chunks, statuscode {status}",
    ...
    "How do you want to open this file?" : "Hoe wilt u dit bestand openen?",
    ...
    "Directory \"{dir}\" is unavailable, please contact the administrator" : "Folder \"{dir}\" is niet beschikbaar, neem contact op met de beheerder",
    "Storage for \"{dir}\" is temporarily not available" : "Opslag voor \"{dir}\" is tijdelijk niet beschikbaar",
    "group" : "groep",
    ...
    "You renamed %2$s to %1$s" : "U hernoemde %2$s naar %1$s",
