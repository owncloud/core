OC.L10N.register(
    ...
    "Upload cancelled." : "Качването е отказано.",
    ...
    "You don’t have permission to upload or create files here" : "Нямате необходимите права да качвате или създавате файлове тук",
    ...
    "Shared directory \"{dir}\" is not available, remove the share or contact it's owner to reshare." : "Споделената директория \"{dir}\" не е налична, премахнете споделянето или се свържете с нейния собственик за да я споделите отново.",
    ...
    "Favorited" : "Любими",
    "Favorite" : "Любими",
    "Private link:  Only people who have access to the file/folder can use it. Use it as a permanent link for yourself or to point others to files within shares" : "Частна връзка: Само хората, които имат достъп до файла/папката могат да я използват. Използвайте я като постоянна връзка за себе си или за да насочвате другите към файлове, които са споделени.",
    "Folder" : "Папка",
