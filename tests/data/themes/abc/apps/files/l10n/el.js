OC.L10N.register(
    ...
    "How do you want to open this file?" : "Πως θέλετε να ανοίξετε αυτό το αρχείο;",
    ...
    "Directory \"{dir}\" is unavailable, please contact the administrator" : "Ο κατάλογος «{dir}» δεν είναι διαθέσιμος, παρακαλούμε επικοινωνήστε με τον διαχειριστή",
    "Storage for \"{dir}\" is temporarily not available" : "Ο αποθηκευτικός χώρος για το «{dir}» δεν είναι προσωρινά διαθέσιμος",
    "Shared directory \"{dir}\" is not available, remove the share or contact it's owner to reshare." : "Ο κοινόχρηστος κατάλογος «{dir}» δεν είναι διαθέσιμος, καταργήστε το κοινόχρηστο ή επικοινωνήστε με τον κάτοχό του για να το ξαναδιαμοιράσει.",
    "Directory \"{dir}\" not found" : "Δεν βρέθηκε ο κατάλογος «{dir}»",
    "group" : "ομάδα",
    ...
    "Encountered problem accessing the folder {name}" : "Αντιμετωπίστηκε πρόβλημα πρόσβασης στο φάκελο {name}",
    ...
    "%1$s was deleted due to automation rule" : "To %1$s διαγράφηκε λόγω κανόνα αυτοματισμού",
    ...
    "You renamed %2$s to %1$s" : "Έχετε μετονομάσει το %2$s σε %1$s",
