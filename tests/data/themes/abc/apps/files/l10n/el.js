OC.L10N.register(
    ...
    "Limit notifications about creation and changes to your <strong>favorite files</strong>" : "Περιορίστε τις ειδοποιήσεις σχετικά με τη δημιουργία και τις αλλαγές στα <strong>αγαπημένα σας αρχεία</strong>",
