OC.L10N.register(
    ...
    "Unable to upload {filename} as it is a directory or has 0 bytes" : "تعذّر رفع {filename} لأنه دليل أو حجمه 0 بايت",
    "Not enough free space, you are uploading {size1} but only {size2} is left" : "لا توجد مساحة تخزين كافية، تُحمِّل {size1} لكن المساحة المتوفرة هي {size2} فقط",
    "Target folder \"{dir}\" does not exist any more" : "المجلد المطلوب \"{dir}\" لم يعد موجودًا بعد الآن",
    ...
    "Could not move \"{file}\", target exists" : "تعذّر نقل \"{file}\"، الملف المطلوب موجود",
    ...
    "Could not move \"{file}\"" : "تعذّر نقل الملف \"{file}\"",
    "{newName} already exists" : "{newName} موجود بالفعل",
    "Could not rename \"{fileName}\", it does not exist any more" : "تعذّرت إعادة تسمية \"{fileName}\"، الملف لم يعد موجودًا بعد الآن",
    ...
    "Error deleting file \"{fileName}\"." : "حدث خطأ أثناء حذف الملف \"{fileName}\".",
    "No entries in this folder match {filter}" : "لا توجد إدخالات في هذا المجلد تتطابق مع {filter}",
    "Name" : "الاسم",
    "Size" : "الحجم",
    "Modified" : "تم التعديل",
    ...
    "The files you are trying to upload exceed the maximum size for file uploads on this server." : "يتجاوز حجم الملفات التي تحاول رفعها الحد الأقصى لحجم الملفات المسموح به للرفع على هذا الخادم.",
