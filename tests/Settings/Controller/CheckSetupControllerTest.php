...
class CheckSetupControllerTest extends TestCase {
	...
	private \PHPUnit\Framework\MockObject\MockObject $checkSetupController;
	...
	public function setUp(): void {
		...
		$this->l10n->expects($this->any())
			->method('t')
			->will($this->returnCallback(fn ($message, array $replace) => \vsprintf($message, $replace)));
		$this->checker = $this->getMockBuilder('\\' . \OC\IntegrityCheck\Checker::class)
				->disableOriginalConstructor()->getMock();
		$this->checkSetupController = $this->getMockBuilder('\\' . \OC\Settings\Controller\CheckSetupController::class)
			->setConstructorArgs([
				'settings',
				$this->request,
				$this->config,
	...
	public function testGetCurlVersion() {
		$checkSetupController = $this->getMockBuilder('\\' . \OC\Settings\Controller\CheckSetupController::class)
			->setConstructorArgs([
				'settings',
				$this->request,
				$this->config,
	...
	public function testIsBuggyNss400() {
		...
		$exception = $this->getMockBuilder('\\' . \GuzzleHttp\Exception\ClientException::class)
			->disableOriginalConstructor()->getMock();
