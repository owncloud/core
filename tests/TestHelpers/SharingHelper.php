...
class SharingHelper {
	 ...
	 *                                   share with.
	 * @param array|null $permissions The permissions to set on the share.
	 ...
	 *
	 * @param string $shareType a keyword from SHARE_TYPES or a share type number
	 *
	 * @return int
	 * @throws InvalidArgumentException
	 *
	 */
	public static function getShareType(string $shareType):int {
