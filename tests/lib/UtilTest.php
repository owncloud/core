...
class UtilTest extends \Test\TestCase {
	...
	public function testFormatDate() {
		...
		$expected = 'October 13, 2012, 11:53:25 AM UTC';
	...
	public function testFormatDateWithTZ() {
		...
		$expected = 'October 13, 2012, 1:53:25 PM GMT+2';
		$this->assertEquals($expected, $result);
	}
	...
	public function formatDateWithTZFromSessionData() {
		return [
			[3, 'October 13, 2012, 2:53:25 PM GMT+3', 'Etc/GMT-3'],
			[15, 'October 13, 2012, 11:53:25 AM UTC', 'UTC'],
			[-13, 'October 13, 2012, 11:53:25 AM UTC', 'UTC'],
			[9.5, 'October 13, 2012, 9:23:25 PM GMT+9:30', 'Australia/Darwin'],
			[-4.5, 'October 13, 2012, 7:23:25 AM GMT-4:30', 'America/Caracas'],
			[15.5, 'October 13, 2012, 11:53:25 AM UTC', 'UTC'],
		];
	}
