...
class OldGroupMembershipSharesTest extends \Test\TestCase {
	...
	public function testRun() {
		...
		$parent = $this->createShare(Share::SHARE_TYPE_GROUP, 'group', null);
		$group2 = $this->createShare(Share::SHARE_TYPE_GROUP, 'group2', $parent);
		$user1 = $this->createShare(Share::SHARE_TYPE_USER, 'user1', $parent);
