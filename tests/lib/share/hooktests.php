...
class HookTests extends TestCase {
	...
	public function testPostAddToGroup() {
		...
		$this->addDummyValuesToUpdateTargets($values);
	...
	/**
	 * the values which should be set for 'updateTargets'
	 *
	 * @param array $value
	 */
	private function addDummyValuesToUpdateTargets($value) {

		$object = new \OC\Share\Hooks();
		$methodName = 'updateTargets';
