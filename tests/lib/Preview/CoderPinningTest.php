...
class CoderPinningTest extends TestCase {
	 ...
	 * on owncloudci/php:7.4 an unpinned %!PS-Adobe read goes to the PS coder, which
	...
	public function testFontNeverInvokesADangerousCoderForForeignContent(): void {
		...
		# Ghostscript's default size, portrait. Measured on owncloudci/php:7.4, 32x19 through
