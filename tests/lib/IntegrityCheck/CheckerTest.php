...
class CheckerTest extends TestCase {
	...
	public function testWriteAppSignature() {
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 1\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
    ...
    "certificate": "-----BEGIN CERTIFICATE-----\r\\r\n4B+pXTAcRK0zECDEaX3npS8xWzrB\r\n-----END CERTIFICATE-----"
		...
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 2\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$this->fileAccessHelper
			->expects($this->once())
		...
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 3\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$keyBundle = \file_get_contents(__DIR__ .'/../../data/integritycheck/SomeApp.crt');
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 4\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$rsaPrivateKey = \file_get_contents(__DIR__ .'/../../data/integritycheck/SomeApp.key');
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 5\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$rsa = new RSA();
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 6\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$rsa->loadKey($rsaPrivateKey);
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 7\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$x509 = new X509();
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 8\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$x509->loadX509($keyBundle);
		echo "In tests/lib/IntegrityCheck/testWriteAppSignature 9\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
		$this->checker->writeAppSignature(\OC::$SERVERROOT . '/tests/data/integritycheck/app/', $x509, $rsa);
		echo "End tests/lib/IntegrityCheck/testWriteAppSignature\n";
		echo "memory_get_usage " . \memory_get_usage() . "\n";
		echo "memory_get_peak_usage " . \memory_get_peak_usage() . "\n";
	}
