...
Feature: create a public link share
  ...
  Scenario Outline: Creating a new public link share of a file with password
    ...
    And the value of the item "//s:message" in the response about user "public" should be "Cannot authenticate over ajax calls"
    ...
    And the value of the item "//s:message" in the response to user "public" should match "/Username or password was incorrect/"
    ...
    And the value of the item "//s:message" in the response to user "public" should match "/No 'Authorization: Basic' header found/"
    Examples:
      | ocs_api_version | ocs_status_code |
      | 1               | 100             |
      | 2               | 200             |
  ...
  Scenario: try to download from a public share that has upload only permissions
    ...
    Then the value of the item "//s:message" in the response about user "public" should be "File not found: parent.txt"
    ...
    Then the value of the item "//s:message" in the response about user "public" should be ""
    And the HTTP status code should be "404"
