...
Feature: Share by public link
  ...
  Scenario: user creates a new public link for a folder containing empty file
    Given user "user1" has created folder "/test"
    And user "user1" has uploaded file with content "" to "/test/test.jpg"
    And user "user1" has logged in using the webUI
    When the user has created a new public link for folder "test" using the webUI
    And the owncloud log is cleared
    And the public accesses the last created public link using the webUI
    Then file "test.jpg" should be listed on the webUI
    And the log file should not contain any entry matching the regular expressions in each of these lines:
      | user      | method  | url                                                                                       | message                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | /^user1$/ | /^GET$/ | /^\/apps\/files_sharing\/ajax\/publicpreview.php?file=%2Ftest.jpg&c=abc&x=36&y=36&t=abc$/ | /^Exception: {\"Exception\":\"Error\",\"Message\":\"Call to a member function file_get_contents() on null\",\"Code\":0,\"Trace\":\"#0 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/legacy\\\/image.php(573): OC\\\\Files\\\\Filesystem::file_get_contents('\\\/var\\\/www\\\/ownclo...')\\n#1 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Preview.php(1170): OC_Image->loadFromFile('\\\/var\\\/www\\\/ownclo...')\\n#2 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Preview.php(799): OC\\\\Preview->getMimeIcon()\\n#3 \\\/var\\\/www\\\/owncloud\\\/apps\\\/files_sharing\\\/ajax\\\/publicpreview.php(112): OC\\\\Preview->showPreview()\\n#4 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Route\\\/Route.php(155): require_once('\\\/var\\\/www\\\/ownclo...')\\n#5 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Route\\\/Router.php(342): OC\\\\Route\\\\Route->OC\\\\Route\\\\{closure}(NULL)\\n#6 \\\/var\\\/www\\\/owncloud\\\/lib\\\/base.php(920): OC\\\\Route\\\\Router->match('\\\/apps\\\/files_sha...')\\n#7 \\\/var\\\/www\\\/owncloud\\\/index.php(54): OC::handleRequest()\\n#8 {main}\",\"File\":\"\\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Files\\\/Filesystem.php\",\"Line\":754}$/ |
      | /^--$/    | /^GET$/ | /^\/apps\/files_sharing\/ajax\/publicpreview.php?file=%2Ftest.jpg&c=abc&x=36&y=36&t=abc$/ | /^Exception: {\"Exception\":\"Error\",\"Message\":\"Call to a member function file_get_contents() on null\",\"Code\":0,\"Trace\":\"#0 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/legacy\\\/image.php(573): OC\\\\Files\\\\Filesystem::file_get_contents('\\\/var\\\/www\\\/ownclo...')\\n#1 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Preview.php(1170): OC_Image->loadFromFile('\\\/var\\\/www\\\/ownclo...')\\n#2 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Preview.php(799): OC\\\\Preview->getMimeIcon()\\n#3 \\\/var\\\/www\\\/owncloud\\\/apps\\\/files_sharing\\\/ajax\\\/publicpreview.php(112): OC\\\\Preview->showPreview()\\n#4 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Route\\\/Route.php(155): require_once('\\\/var\\\/www\\\/ownclo...')\\n#5 \\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Route\\\/Router.php(342): OC\\\\Route\\\\Route->OC\\\\Route\\\\{closure}(NULL)\\n#6 \\\/var\\\/www\\\/owncloud\\\/lib\\\/base.php(920): OC\\\\Route\\\\Router->match('\\\/apps\\\/files_sha...')\\n#7 \\\/var\\\/www\\\/owncloud\\\/index.php(54): OC::handleRequest()\\n#8 {main}\",\"File\":\"\\\/var\\\/www\\\/owncloud\\\/lib\\\/private\\\/Files\\\/Filesystem.php\",\"Line\":754}$/ |
