...
Feature: Sharing files and folders with internal users with expiration date set/unset
  ...
  Scenario: expiration date is enabled but not enforced, user receives a share with expiration date and reshares with expiration date in future than the original
    Given parameter "shareapi_default_expire_date_user_share" of app "core" has been set to "yes"
    And parameter "shareapi_enforce_expire_date_user_share" of app "core" has been set to "no"
    And user "user3" has created a share with settings
    | path        | /lorem.txt |
  ...
  Scenario: expiration date is enabled and enforced, user receives a share with expiration date and tries to reshare with expiration date in future than the original
    Given parameter "shareapi_default_expire_date_user_share" of app "core" has been set to "yes"
    And parameter "shareapi_enforce_expire_date_user_share" of app "core" has been set to "yes"
    And parameter "shareapi_expire_after_n_days_user_share" of app "core" has been set to "30"
    And user "user3" has created a share with settings
  ...
  Scenario: expiration date is enabled and enforced for group, user receives a folder from a user share with expiration date and shares sub-folder with another user
    Given parameter "shareapi_default_expire_date_user_share" of app "core" has been set to "yes"
    And parameter "shareapi_enforce_expire_date_user_share" of app "core" has been set to "yes"
    And parameter "shareapi_expire_after_n_days_user_share" of app "core" has been set to "30"
    And user "user3" has created a share with settings
