...
Feature: Title of your feature
  ...
  Scenario: User can assign tags when in the tag's groups
    ...
    And user "user0" should be able to assign the "not user-assignable" tag with name "TagWithGroups"
  ...
  Scenario: User can assign static tags when in the tag's groups
    ...
    Then the HTTP status code should be "201"
    And user "user0" should be able to assign the "static" tag with name "TagWithGroups"
  ...
  Scenario: User cannot assign tags when not in the tag's groups
    ...
    Then the HTTP status code should be "201"
    And user "user0" should not be able to assign the "not user-assignable" tag with name "TagWithGroups"
