...
Feature: file versions remember the author of each version
  ...
  Scenario: enable file versioning and check the history of changes from multiple users
    ...
    And the content of non-current version index "1" of file "/test/textfile0.txt" for user "Alice" should be "uploaded content carol"
    And the content of non-current version index "2" of file "/test/textfile0.txt" for user "Alice" should be "uploaded content brian"
    And the content of non-current version index "3" of file "/test/textfile0.txt" for user "Alice" should be "uploaded content alice"
    And as users "Alice" the authors of the non-current versions of file "/test/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
    And as users "Brian,Carol,David" the authors of the non-current versions of file "/Shares/test/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
  ...
  Scenario: enable file versioning and check the history of changes from multiple users for shared folder in the group
    ...
    And the content of non-current version index "1" of file "/test/textfile0.txt" for user "Alice" should be "uploaded content brian"
    And the content of non-current version index "2" of file "/test/textfile0.txt" for user "Alice" should be "uploaded content alice"
    And as users "Alice" the authors of the non-current versions of file "/test/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
    And as users "Brian,Carol" the authors of the non-current versions of file "/Shares/test/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
  ...
  Scenario: enable file versioning and check the history of changes from multiple users for shared file in the group
    ...
    Then the HTTP status code should be "207"
    And the number of non-current versions should be "2"
    And the content of non-current version index "1" of file "/textfile0.txt" for user "Alice" should be "uploaded content brian"
    And the content of non-current version index "2" of file "/textfile0.txt" for user "Alice" should be "uploaded content alice"
    And as users "Alice" the authors of the non-current versions of file "/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
    And as users "Brian,Carol" the authors of the non-current versions of file "/Shares/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
  ...
  Scenario: enable file versioning and check the history of changes from multiple users after renaming file by sharer
    ...
    And the content of non-current version index "1" of file "/textfile0.txt" for user "Alice" should be "uploaded content brian"
    And the content of non-current version index "2" of file "/textfile0.txt" for user "Alice" should be "uploaded content alice"
    And as user "Alice" the authors of the non-current versions of file "/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
    And as users "Brian,Carol" the authors of the non-current versions of file "/Shares/exist.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
  ...
  Scenario: enable file versioning and check the history of changes in sharer after renaming file by sharee
    ...
    Then the HTTP status code should be "207"
    And the number of non-current versions should be "2"
    And the content of non-current version index "1" of file "/exist.txt" for user "Alice" should be "uploaded content brian"
    And the content of non-current version index "2" of file "/exist.txt" for user "Alice" should be "uploaded content alice"
    And as users "Alice" the authors of the non-current versions of file "/exist.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
    And as users "Carol" the authors of the non-current versions of file "/Shares/exist.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
    And as user "Brian" the authors of the non-current versions of file "/Shares/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     | Alice  |
  ...
  Scenario: enable file versioning and check the history of changes from multiple users who have a matching folder/file
    ...
    And as users "Alice" the authors of the non-current versions of file "/test/textfile0.txt" should be:
      ...
      | 2     | Brian  |
      | 3     | Alice  |
    And as users "Brian,Carol,David" the authors of the non-current versions of file "/Shares/test (2)/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
    ...
    Then the HTTP status code should be "207"
    And the number of non-current versions should be "1"
    And the content of non-current version index "1" of file "/test/textfile0.txt" for user "Brian" should be "duplicate brian"
    And as user "Brian" the authors of the non-current versions of file "/test/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
  ...
  Scenario: enable file versioning and check the history of changes from multiple users who have a matching file
    ...
    Then the HTTP status code should be "207"
    And the number of non-current versions should be "3"
    And the content of non-current version index "1" of file "/textfile0.txt" for user "Alice" should be "uploaded content carol"
    And the content of non-current version index "2" of file "/textfile0.txt" for user "Alice" should be "uploaded content brian"
    And the content of non-current version index "3" of file "/textfile0.txt" for user "Alice" should be "uploaded content alice"
    And as users "Alice" the authors of the non-current versions of file "/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
    And as users "Brian,Carol,David" the authors of the non-current versions of file "/Shares/textfile0 (2).txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
    ...
    Then the HTTP status code should be "207"
    And the number of non-current versions should be "1"
    And the content of non-current version index "1" of file "/textfile0.txt" for user "Brian" should be "duplicate brian"
    And as user "Brian" the authors of the non-current versions of file "/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
  ...
  Scenario: enable file versioning and check the version author after restoring a version of a file inside a folder
    ...
    And as user "Alice" the authors of the non-current versions of file "/test/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
    And as user "Brian,Carol" the authors of the non-current versions of file "/Shares/test/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
  ...
  Scenario: enable file versioning and check the version author after restoring a version of a file
    ...
    And as user "Alice" the authors of the non-current versions of file "/textfile0.txt" should be:
      ...
      | 2     | Brian  |
      | 3     | Alice  |
    And as user "Brian,Carol" the authors of the non-current versions of file "/Shares/textfile0.txt" should be:
      | index | author |
      | 1     | Carol  |
      | 2     | Brian  |
      | 3     | Alice  |
  ...
  Scenario: check the author of the file version (inside a folder) which was created before enabling the version storage
    ...
    And as user "Alice" the authors of the non-current versions of file "/test/textfile0.txt" should be:
      ...
      | 1     | Brian  |
      | 2     |        |
    And as user "Brian" the authors of the non-current versions of file "/Shares/test/textfile0.txt" should be:
      | index | author |
      | 1     | Brian  |
      | 2     |        |
    When user "Brian" restores version index "1" of file "/Shares/test/textfile0.txt" using the WebDAV API
