        ...
        "capabilities": {
          ...
          "properties": {
            "core": {
              ...
              "properties": {
                "pollinterval": {"type": "string", "enum":["30000"]},
                "webdav-root": {"type": "string", "pattern": "remote.php/webdav"},
                "status": {
                  "type":"object",
                  "required": [
                    "version",
                  ...
                  "properties": {
                    ...
                    "versionstring": {"type": "string", "pattern": "[A-Za-z0-9]+"},
                    "edition": {"type": "string", "pattern": "[A-Za-z0-9]+"},
                    "productname": {"type": "string", "pattern": "[A-Za-z0-9]+"}
                  }
                }
              }
            },
            "files": {
              ...
              "properties": {
                ...
                "versionstring": {"type": "string", "pattern": "1"},
                "edition": {"type": "string", "pattern": "1"}
              }
            },
            "files_sharing": {
              "type":"object",
              ...
              "properties": {
                "api_enabled": {"type": "string", "pattern": "1"},
                "default_permissions": {"type": "string", "pattern": "31"},
                "search_min_length": {"type": "string", "pattern": "2"},
                "public": {
                  "type":"object",
                  "required": [
                    "enabled",
                  ...
                  "properties": {
                    "enabled": {"type": "string", "pattern": "1"},
                    "multiple": {"type": "string", "pattern": "1"},
                    "upload": {"type": "string", "pattern": "1"},
                    "supports_upload_only": {"type": "string", "pattern": "1"},
                    "send_mail": {"type": "array"},
                    "social_share": {"type": "string", "pattern": "1"},
                    "defaultPublicLinkShareName": {"type": "string", "pattern": "Public link"}
                  }
                },
                "resharing": {"type": "string", "pattern": "1"},
                "federation": {
                  "type":"object",
                  "required": [
                    "outgoing",
                  ...
                  "properties": {
                    "outgoing": {"type": "string", "pattern": "1"},
                    "incoming": {"type": "string", "pattern": "1"}
                  }
                },
                "group_sharing": {"type": "string", "pattern": "1"},
                "share_with_group_members_only": {"type": "array"},
                "share_with_membership_groups_only": {"type": "array"},
                "auto_accept_share": {"type": "string", "pattern": "1"},
                "user_enumeration": {
                  "type":"object",
                  "required": [
                    "enabled",
