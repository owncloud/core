...
Feature: upload file
  ...
  Scenario Outline: upload file with mtime
    Given using <dav_version> DAV path
    When user "Alice" uploads a file to "file.txt" with mtime "Thu, 08 Aug 2019 04:18:13 GMT" using the WebDAV API
  ...
  Scenario Outline: upload a file with mtime in a folder
    ...
    When user "Alice" uploads a file to "/testFolder/file.txt" with mtime "Thu, 08 Aug 2019 04:18:13 GMT" using the WebDAV API
