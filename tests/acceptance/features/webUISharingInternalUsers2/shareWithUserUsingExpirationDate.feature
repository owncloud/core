...
Feature: Sharing files and folders with internal users with expiration date set/unset
  ...
  Scenario: expiration date is disabled for sharing with users, user shares with another user
    ...
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be visible for the user "Brian Murphy" in the share dialog
    And the expiration date input field should be empty for the user "Brian Murphy" in the share dialog
  ...
  Scenario: expiration date is enabled for sharing with users, user shares file with another user
    ...
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be visible for the user "Brian Murphy" in the share dialog
    And the expiration date input field should be "+7 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | expiration  | +7 days    |
  ...
  Scenario Outline: expiration date is enforced for user, user shares file
    ...
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be visible for the user "Brian Murphy" in the share dialog
    And the expiration date input field should be "<days>" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | expiration  | <days>     |
  ...
  Scenario: expiration date is enforced for user, user shares and tries to change expiration date more than allowed
    ...
    And user "Alice" has logged in using the webUI
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    And the user changes expiration date for share of user "Brian Murphy" to "+4 days" in the share dialog
    Then the expiration date input field should be "+3 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | expiration  | +3 days    |
  ...
  Scenario: expiration date is enforced for user, user reshares received file with another user
    ...
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be visible for the user "Brian Murphy" in the share dialog
    And the expiration date input field should be "+3 days" for the user "Brian Murphy" in the share dialog
  ...
  Scenario: expiration date is enabled but not enforced for user, user reshares received file with another user, but removes default expiration date
    ...
    And user "Alice" has logged in using the webUI
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    And the user clears the expiration date input field for share of user "Brian Murphy" in the share dialog
    Then the expiration date input field should be empty for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | uid_owner   | Alice      |
  ...
  Scenario: expiration date is enabled but not enforced for user, user reshares received file with another user, but changes expiration date
    ...
    And user "Alice" has logged in using the webUI
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    And the user changes expiration date for share of user "Brian Murphy" to "+15 days" in the share dialog
    Then the expiration date input field should be "+15 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | uid_owner   | Alice      |
  ...
  Scenario: expiration date is enabled but not enforced, user shares through api and checks the expiration date on webUI
    ...
    Then the expiration date input field should be "+15 days" for the user "Alice Hansen" in the share dialog
  ...
  Scenario: expiration date is enabled but not enforced, user receives a share with expiration date and reshares with expiration date less than the original
    ...
    And user "Alice" has logged in using the webUI
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be "+7 days" for the user "Brian Murphy" in the share dialog
    When the user changes expiration date for share of user "Brian Murphy" to "+10 days" in the share dialog
    Then the expiration date input field should be "+10 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | uid_owner   | Alice      |
  ...
  Scenario: expiration date is enabled but not enforced, user receives a share with expiration date and reshares it, setting a date further in future than the original
    ...
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be "+7 days" for the user "Brian Murphy" in the share dialog
    When the user changes expiration date for share of user "Brian Murphy" to "+20 days" in the share dialog
    Then the expiration date input field should be "+20 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
      | uid_owner   | Alice      |
  ...
  Scenario: expiration date is enabled and enforced, user receives a share with expiration date and tries to reshare with expiration date less than the original
    ...
    And user "Alice" has logged in using the webUI
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be "+30 days" for the user "Brian Murphy" in the share dialog
    When the user changes expiration date for share of user "Brian Murphy" to "+20 days" in the share dialog
    Then the expiration date input field should be "+20 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
  ...
  Scenario: expiration date is enabled and enforced, user receives a share with expiration date and tries to reshare it with a date further in future than the original
    ...
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be "+30 days" for the user "Brian Murphy" in the share dialog
    When the user changes expiration date for share of user "Brian Murphy" to "+40 days" in the share dialog
    Then the expiration date input field should be "+30 days" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
      | file_target | /lorem.txt |
  ...
  Scenario: expiration date is enabled and enforced, user receives a folder from a user share with expiration date and shares sub-folder with another user
    ...
    And the user shares file "simple-empty-folder" with user "Brian Murphy" using the webUI without closing the share dialog
    Then the expiration date input field should be "+30 days" for the user "Brian Murphy" in the share dialog
    When the user changes expiration date for share of user "Brian Murphy" to "+20 days" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user                 |
  ...
  Scenario Outline: expiration date is disabled for sharing with users, user shares file with another user and sets expiration date
    ...
    And user "Alice" has logged in using the webUI
    When the user shares file "lorem.txt" with user "Brian Murphy" using the webUI without closing the share dialog
    And the user changes expiration date for share of user "Brian Murphy" to "<days>" in the share dialog
    Then the expiration date input field should be visible for the user "Brian Murphy" in the share dialog
    And the expiration date input field should be "<days>" for the user "Brian Murphy" in the share dialog
    And the information of the last share of user "Alice" should include
      | share_type  | user       |
  ...
  Scenario: share with multiple users and change the sharing permissions and expiration date
    ...
    Then the information for user "Alice" about the received share of folder "simple-folder" should include
      ...
      | share_with  | Alice          |
      | permissions | 17             |
    When the user sets the sharing permissions of user "Brian Murphy" for "simple-folder" using the webUI to
      | share    | no |
      | delete   | no |
    And the user changes expiration date for share of user "Brian Murphy" to "+7 days" in the share dialog
    Then the information for user "Brian" about the received share of folder "simple-folder" should include
      | share_type  | user           |
      | file_target | /simple-folder |
      | expiration  | +7 days        |
      | uid_owner   | Carol          |
