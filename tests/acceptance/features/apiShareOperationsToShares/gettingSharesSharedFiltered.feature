...
Feature: sharing
  ...
  Scenario Outline: getting shares shared to users
    ...
    But folder "/Shares/folderToShareWithGroup" should not be included in the response
    And folder "/Shares/fileToShareWithGroup.txt" should not be included in the response
    And folder "/Shares/folderToShareWithPublic" should not be included in the response
    And folder "/Shares/fileToShareWithPublic.txt" should not be included in the response
    Examples:
  ...
  Scenario Outline: getting shares shared to groups
    ...
    But folder "/Shares/folderToShareWithUser" should not be included in the response
    And file "/Shares/fileToShareWithUser.txt" should not be included in the response
    And folder "/Shares/folderToShareWithPublic" should not be included in the response
    And folder "/Shares/fileToShareWithPublic.txt" should not be included in the response
    Examples:
      | ocs_api_version | ocs_status_code |
  ...
  Scenario Outline: getting shares shared to public links
    ...
    But folder "/Shares/folderToShareWithUser" should not be included in the response
    And file "/Shares/fileToShareWithUser.txt" should not be included in the response
    And folder "/Shares/folderToShareWithGroup" should not be included in the response
    And folder "/Shares/fileToShareWithGroup.txt" should not be included in the response
    Examples:
      | ocs_api_version | ocs_status_code |
      | 1               | 100             |
  ...
  Scenario Outline: getting shares shared to users and groups
    ...
    And folder "/Shares/folderToShareWithGroup" should be included in the response
    And folder "/Shares/fileToShareWithGroup.txt" should be included in the response
    But folder "/Shares/folderToShareWithPublic" should not be included in the response
    And folder "/Shares/fileToShareWithPublic.txt" should not be included in the response
    Examples:
      | ocs_api_version | ocs_status_code |
      | 1               | 100             |
