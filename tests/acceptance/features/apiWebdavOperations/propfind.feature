...
Feature: PROPFIND
  ...
  Scenario: send PROPFIND requests to public link
    Given user "Alice" has been created with default attributes and without skeleton files
  ...
  Scenario: send PROPFIND requests to public link shared with password
    Given user "Alice" has been created with default attributes and without skeleton files
    And user "Alice" has created folder "/PARENT"
    And user "Alice" has created a public link share with settings
      | path        | /PARENT |
  ...
  Scenario: send PROPFIND requests to public link shared with password (request without password)
    Given user "Alice" has been created with default attributes and without skeleton files
    And user "Alice" has created folder "/PARENT"
    And user "Alice" has created a public link share with settings
      | path        | /PARENT |
