...
trait Sharing {
	 ...
	 * @return void
	 */
	public function emptyCreatedUserGroupShares(string $user): void {
		if (isset($this->createdUserGroupShares["$user"])) {
			unset($this->createdUserGroupShares["$user"]);
		}
	}
	...
	public function getPublicPreviewOfFile(string $fileName, string $token):void {
		$url = $this->getBaseUrl() .
			"/index.php/apps/files_sharing/ajax/publicpreview" .
