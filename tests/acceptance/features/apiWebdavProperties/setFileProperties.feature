...
Feature: set file properties
  ...
  Scenario Outline: Setting custom DAV property and reading it
    ...
    And user "meta" has uploaded file "data/textfile.txt" to "/testcustomprop.txt"
    And user "meta" has set property "{http://whatever.org/ns}very-custom-prop" of file "/testcustomprop.txt" to "veryCustomPropValue"
    When user "meta" gets a custom property "{http://whatever.org/ns}very-custom-prop" of file "/testcustomprop.txt"
  ...
  Scenario Outline: Setting custom DAV property and reading it after the file is renamed
    Given using <dav_version> DAV path
    And user "meta" has uploaded file "data/textfile.txt" to "/testcustompropwithmove.txt"
    And user "meta" has set property "{http://whatever.org/ns}very-custom-prop" of file "/testcustompropwithmove.txt" to "valueForMovetest"
    And user "meta" has moved file "/testcustompropwithmove.txt" to "/catchmeifyoucan.txt"
    When user "meta" gets a custom property "{http://whatever.org/ns}very-custom-prop" of file "/catchmeifyoucan.txt"
  ...
  Scenario Outline: Setting custom DAV property on a shared file as an owner and reading as a recipient
    ...
    And user "meta" has uploaded file "data/textfile.txt" to "/testcustompropshared.txt"
    And user "meta" has created a share with settings
      | path        | testcustompropshared.txt |
      | shareType   | 0                        |
      | permissions | 31                       |
      | shareWith   | user1                    |
    And user "meta" has set property "{http://whatever.org/ns}very-custom-prop" of file "/testcustompropshared.txt" to "valueForSharetest"
  ...
  Scenario Outline: Setting custom DAV property using one endpoint and reading it with other endpoint
    ...
    And user "meta" has uploaded file "data/textfile.txt" to "/testnewold.txt"
    And user "meta" has set property "{http://whatever.org/ns}very-custom-prop" of file "/testnewold.txt" to "lucky"
    And using <other_dav_version> DAV path
    When user "meta" gets a custom property "{http://whatever.org/ns}very-custom-prop" of file "/testnewold.txt"
  ...
  Scenario: Setting custom DAV property using an old endpoint and reading it using a new endpoint
    ...
    Given user "meta" has uploaded file "data/textfile.txt" to "/testoldnew.txt"
    And user "meta" has set property "{http://whatever.org/ns}very-custom-prop" of file "/testoldnew.txt" to "constant"
    And using new DAV path
    When user "meta" gets a custom property "{http://whatever.org/ns}very-custom-prop" of file "/testoldnew.txt"
