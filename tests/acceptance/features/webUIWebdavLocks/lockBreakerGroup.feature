...
#  Scenario: Add multiple groups as lock breakers group
#    Given group "group1" has been created
#    And group "group2" has been created
#    And group "group3" has been created
#    And the administrator has browsed to the admin general settings page
#    When the administrator adds group "group1" to lock breakers group using the webUI
#    And the administrator adds group "group2" to lock breakers group using the webUI
#    And the administrator adds group "group3" to lock breakers group using the webUI
