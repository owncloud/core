...
* Change - Update PHP dependencies: [#41195](https://github.com/owncloud/core/pull/41195)
   ...
   v0.338.0) - google/auth (v1.35.0 to v1.37.0) - pear/pear-core-minimal (v1.10.14
   to v1.10.15) - phpseclib/phpseclib (3.0.35 to 3.0.37) - symfony/console (v5.4.35
   to v5.4.36) - symfony/process (v5.4.35 to v5.4.36) - symfony/routing (v5.4.35 to
   v5.4.37) - symfony/string (v5.4.35 to v5.4.36)
