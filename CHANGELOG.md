...
### Deprecated
### Removed
- Remove themes folder from Makefile - #28617
- Remove unused Windows checks - #28612
- Do not allow slash in filename when renaming in the frontend (unintended "feature") - #28490
...
- Better support of read only config file and apps folder - #28594 #28601
...
- Prevent file cache inconsistencies when moving a subtree in or out of a share - #28219
