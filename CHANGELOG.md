...
* Change - Update PHP dependencies: [#41287](https://github.com/owncloud/core/pull/41287)
   ...
   laravel/serializable-closure (1.3.3 to 1.3.6) - league/mime-type-detection
   (1.15.0 to 1.16.0) - mikey179/vfsstream (1.6.11 to 1.6.12) - monolog/monolog
   (2.9.3 to 2.10.0) - phpseclib/phpseclib (3.0.39 to 3.0.42) - sabre/dav (4.6.0 to
   ...
   to 2.2.11) - symfony/console (5.4.40 to 5.4.47) - symfony/event-dispatcher
   (5.4.40 to 5.4.45) - symfony/polyfill-php80 (1.29.0 to 1.31.0) - symfony/process
   (v5.4.40 to v5.4.47) - symfony/routing (5.4.40 to 5.4.45) - symfony/string
