...
* Change - Update PHP dependencies: [#41033](https://github.com/owncloud/core/pull/41033)
   ...
   1.14.0) - monolog/monolog (2.9.1 to 2.9.2) - sabre/dav (4.4.0 to 4.5.0) - sabre/vobject
   (4.5.3 to 4.5.4) - symfony/console (5.4.28 to 5.4.31) - symfony/string (5.4.29 to 5.4.31) -
